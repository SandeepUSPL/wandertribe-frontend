...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1084px)" href="css/ExperienceDetail.css">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 601px) and (max-width: 1083px)"
        href="css/ExperienceDetail600up.css">
    <link rel="stylesheet" type="text/css" media="screen and (max-width: 600px)" href="css/ExperienceDetail600down.css">
...
<body>
    ...
    <div class="row impDetail">
        <div class="col-sm-7">
            ...
            <p class="overview">A town with a historical touch and riverbank geography will just take your breath away!
                Rishikesh is settled in foothills of Himalaya while residing in the state of Uttrakhand. The city
                attracts most of the travellers because of its mountain views, religious touch, and adventurous
                activities.
            </p>
            <h3>Itinerary</h3>
            ...
            <div class="inclusions">
                <h4>Stays</h4>
                <p>Stay is arranged on multiple sharing basis in tents. 2/4/8 people sharing tent can be provided
                    depending on the group size. Stay would be there in shades during monsoon.
                </p>
                <h4>Meal</h4>
                <p>Snacks in the evening : Tea and Pakoda Free BBQ (Limited - One serving each traveller) Veg- Dinner :
                    Dal tadka, Paneer sabji or veg sabji, chapati, steamed rice, salad Non Veg- Dinner : Chicken curry,
                    Chicken dry masala, chapati, steamed rice, salad Breakfast on the second day: Tea and Poha
                </p>
            </div>
        </div>
    ...
    <script type="text/javascript" src="js/ExperienceDetail.js"></script>
