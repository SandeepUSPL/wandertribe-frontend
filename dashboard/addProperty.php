...
<div id="wrap">
    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <!-- submenu -->
            <div class="submenu">
                <h1><strong>Add Property</strong></h1>
                <div class="collapsed">
                    <a href="#" id="submenutoggle"><h1>Add Property<i class="fa fa-bars"></i></h1></a>
                </div>
            </div>
            <!-- /submenu -->
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="file" class="form-control dropzone" id="camp_image" name="camp_image[]"
...
<!--                        </div>-->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" id="second_part" style="margin-top: 50px">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="margin-top: 100px !important;">
                            <label class="col-md-10 col-sm-10 col-xs-10 col-xs-offset-2 control-label" style="text-align: left !important;">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-xs-10">
                                    I hereby certify that I am the property owner and/or manager for the previous referenced address.
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                 <div class="col-xs-2 text-right">
                                ...
                                <div class="col-xs-10">
                                    I certify that this is a legitimate accommodation business with all necessary licenses and permits, which can be shown upon first request. Wandertribe.in reserves the right to verify and investigate any details provided in this registration.
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-xs-10">
                                    I have read, accepted and agreed to the <a href="termsConditions.php" target="_blank">General Terms & Conditions</a>.
                                </div>
                            </div>
                        </div>
        ...
        // if ((valid_tent || valid_homestay || valid_cottage || valid_dome || valid_swiss)&&least_flag) {
            ...
            if (auth_key != undefined) {
                $.ajax({
                    ...
                    url: '<?php echo $_SERVER['API_ENDPOINTS'];?>/api/new_property',
                    type: 'post',
                    ...
                    success: function (data, textStatus, xhr) {
                        ...
                        if (xhr.status == 200) {
                            ...
                            top.location.href = 'addPropertyType.php?c_id=' + data.result;
                        }
