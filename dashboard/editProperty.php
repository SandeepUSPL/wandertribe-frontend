...
<div id="wrap">
    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <!-- submenu -->
            <div class="submenu">
                <h1><strong>Edit Property</strong></h1>
                <div class="collapsed">
                    <a href="#" id="submenutoggle"><h1>Edit Property<i class="fa fa-bars"></i></h1></a>
                </div>
            </div>
            <!-- /submenu -->
            ...
            <div class="main row">
                    ...
                    <div id="first_part" style="">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <input type="hidden" name="camp_id" id="camp_id" value="<?php echo $_GET['c_id']; ?>">
<!--                            <input type="hidden" name="camp_code" id="camp_code" value="">-->
<!--                            <input type="hidden" name="camp_type_data" id="camp_type_data" value="">-->
...
<!--                            <input type="hidden" name="is_homestay" id="is_homestay" value="">-->
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <select class="form-control" name="destination_name" id="destination_name" readonly>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="camp_name" class="col-md-5 col-sm-5 col-xs-12 control-label">Property
                                    Name* </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text" class="form-control" id="camp_name" name="camp_name" value="" required>
                                </div>
                            </div>
...
<!--                        </div>-->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" id="second_part" style="margin-top: 50px">
...
<!--                            </div>-->
<!---->
<!--                            <div id="homestay" class="col-md-12 col-sm-12 col-xs-12 tabcontent">-->
<!--                                <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">-->
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Max Occupancy</label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <select class="form-control" name="homestay_occupancy"-->
<!--                                                    id="homestay_occupancy">-->
<!--                                                <option value="single">Single</option>-->
<!--                                                <option value="double">Double</option>-->
<!--                                                <option value="triple">Triple</option>-->
<!--                                                <option value="quad">Quad</option>-->
...
<!--                                               class="col-md-5 col-sm-5 col-xs-12 control-label">Category </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="text" class="form-control" id="homestay_category"-->
<!--                                                   name="homestay_category" value="">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
<!--                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">-->
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Price per camp </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control" id="homestay_price_per_camp"-->
<!--                                                   name="homestay_price_per_camp" value="" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                            Person </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control" id="homestay_price_per_person"-->
<!--                                                   name="homestay_price_per_person" value="" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Inventory </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control" id="homestay_no_of_inventory"-->
<!--                                                   name="homestay_no_of_inventory" value="" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">CGST (%)</label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control gst" id="homestay_cgst"-->
<!--                                                   name="homestay_cgst" value="" max="100" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">SGST (%)</label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control gst" id="homestay_sgst"-->
<!--                                                   name="homestay_sgst" value="" max="100" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">IGST (%)</label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="number" class="form-control gst" id="homestay_igst"-->
<!--                                                   name="homestay_igst" value="" max="100" min="0"-->
<!--                                                   oninput="validity.valid||(value='');">-->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                            Controller </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <select class="form-control" name="homestay_temprature_controller"-->
<!--                                                    id="homestay_temprature_controller">-->
<!--                                                <option value="fan">Fan</option>-->
<!--                                                <option value="cooler">Cooler</option>-->
<!--                                                <option value="ac">AC</option>-->
<!--                                                <option value="none">None</option>-->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Power<br>Supply</label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <select class="form-control" name="homestay_power_supply"-->
<!--                                                    id="homestay_power_supply">-->
<!--                                                <option value="common">Common</option>-->
<!--                                                <option value="private">Private</option>-->
<!--                                            </select>-->
<!--                                        </div>-->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Washroom </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <select class="form-control" name="homestay_washroom"-->
<!--                                                    id="homestay_washroom">-->
<!--                                                <option value="common">Common</option>-->
<!--                                                <option value="private">Private</option>-->
<!--                                            </select>-->
<!--                                        </div>-->
...
<!--                                        <label class="col-md-5 col-sm-5 col-xs-12 control-label">Washroom Type </label>-->
<!--                                        <div class="col-md-7 col-sm-7 col-xs-12">-->
<!--                                            <input type="checkbox" name="homestay_indian" value="indian"-->
<!--                                                   id="homestay_indian"> Indian <br>-->
<!--                                            <input type="checkbox" name="homestay_western" value="western"-->
<!--                                                   id="homestay_western">Western <br>-->
<!--                                            <input type="checkbox" name="homestay_pit" value="pit" id="homestay_pit">Pit-->
<!---->
<!--                                        </div>-->
<!--                                    </div>-->
<!---->
...
<!--                                        <div class="col-md-12 col-sm-12 col-xs-12">-->
<!--                                            <label class="col-md-12 col-sm-12 col-xs-12 control-label"-->
<!--                                                   style="text-align: left">Add Home Stay Image </label>-->
<!--                                            <input type="file" class="form-control" id="homestay_image"-->
<!--                                                   name="homestay_image[]" placeholder=""-->
<!--                                                   onchange="show_homestay_image(this);" multiple>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    <div class="col-md-12 col-sm-12 col-xs-12 show-tent-image-div"-->
<!--                                         id="homestay_image_div">-->
<!---->
<!--                                    </div>-->
<!---->
<!--                                </div>-->
...
<script>
    ...
    $(document).ready(function get_camp_details() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $_SERVER['API_ENDPOINTS'];?>/api/get_property',
            headers: {
                "auth_key": localStorage.getItem('auth_key')
            },
            data: {
                camp_id:  <?php echo $_GET['c_id']; ?>
            },
            success: function (response) {
                console.log(response.result);

                var destination_name = (response.result.destination.destination_name != undefined) ? response.result.destination.destination_name : '';
                ...
                //
                // var homestay_price_per_camp = (response.result.is_homestay == 'Yes') ? response.result.homestay.price_per_camp : '';
                // var homestay_price_per_person = (response.result.is_homestay == 'Yes') ? response.result.homestay.price_per_person : '';
                // var homestay_no_of_inventory = (response.result.is_homestay == 'Yes') ? response.result.homestay.no_of_inventory : '';
                // var homestay_cgst = (response.result.is_homestay == 'Yes') ? response.result.homestay.cgst : '';
                // var homestay_sgst = (response.result.is_homestay == 'Yes') ? response.result.homestay.sgst : '';
                // var homestay_igst = (response.result.is_homestay == 'Yes') ? response.result.homestay.igst : '';
                // var homestay_category = (response.result.is_homestay == 'Yes') ? response.result.homestay.category : '';

                $(response.result.image).each(function (indx, value) {

                    if (value.image_type == "camp") {

                        $($.parseHTML('<img>')).attr('src', value.image_url).appendTo("#old_camp_image_div");
                    }
                    if (value.image_type == "meal") {
                        $($.parseHTML('<img>')).attr('src', value.image_url).appendTo("#old_meal_image_div");
                    }
                    // if (value.imageType == "tent") {
                    //     $($.parseHTML('<img>')).attr('src', value.imageUrl).appendTo("#old_tent_image_div");
                    // }
                    // if (value.imageType == "dome") {
                    //     $($.parseHTML('<img>')).attr('src', value.imageUrl).appendTo("#old_dome_image_div");
                    // }
                    // if (value.imageType == "swiss") {
                    //     $($.parseHTML('<img>')).attr('src', value.imageUrl).appendTo("#old_swiss_image_div");
                    // }
                    // if (value.imageType == "cottage") {
                    //     $($.parseHTML('<img>')).attr('src', value.imageUrl).appendTo("#old_cottage_image_div");
                    // }
                    // if (value.imageType == "homestay") {
                    //     $($.parseHTML('<img>')).attr('src', value.imageUrl).appendTo("#old_homestay_image_div");
                    // }
                ...
                //
                //     $("#homestay_occupancy").val(response.result.homestay.occupancy);
                //     $("#homestay_power_supply").val(response.result.homestay.power_supply);
                //     $("#homestay_washroom").val(response.result.homestay.washroom);
                //     $("#homestay_washroom_type").val(response.result.homestay.washroom_type);
                //     $("#homestay_temprature_controller").val(response.result.homestay.temprature_controller);
                //     $("#homestay_cgst").val(response.result.homestay.cgst);
                //     $("#homestay_sgst").val(response.result.homestay.sgst);
                //     $("#homestay_igst").val(response.result.homestay.igst);
                // }
                //
                ...
                $('#destination_name').val(destinationSplit[0]);
                ...
                } if (response.result.camp_info.veg_food == 'Y') {
                    $('#food_veg').attr('checked', true);
                }
                if (response.result.camp_info.non_veg_food == 'Y') {
                    $('#food_non_veg').attr('checked', true);
                }
                ...
                //
                // //homestay
                // $('#homestay_price_per_camp').val(homestay_price_per_camp);
                // $('#homestay_price_per_person').val(homestay_price_per_person);
                // $('#homestay_no_of_inventory').val(homestay_no_of_inventory);
                // $('#homestay_category').val(homestay_category);
    ...
    frm.submit(function (e) {
        ...
        $.ajax({
            ...
            url: '<?php echo $_SERVER['API_ENDPOINTS'];?>/api/edit_property',
            type: 'POST',
...
<script>
    ...
    // }
    //
    // function show_homestay_image(input) {
    //
    //     if (input.files) {
    ...
    //
    //             reader.onload = function (event) {
    //                 $($.parseHTML('<img>')).attr('src', event.target.result).appendTo("#homestay_image_div");
    //             }
    //
    //             reader.readAsDataURL(input.files[i]);
    //         }
