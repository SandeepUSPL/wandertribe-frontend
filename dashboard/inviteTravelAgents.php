...
<html>
  <head>    <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <title>Invite Travel Agents</title>
    ...
    <div id="wrap">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <!-- submenu -->
          <div class="submenu">
            <h1><strong>Invite Travel Agents</strong></h1>
            <div class="collapsed">
              <a href="#" id="submenutoggle"><h1>Invite Travel Agents <i class="fa fa-bars"></i></h1></a>
            </div>
          </div>
          <!-- /submenu -->
          ...
          <div class="main row">
            ...
            <div class="margin-left-20" style="text-align: center">
              <h3>Copy and Share this link to invite travel agents</h3>
              <hr>
            </div>
