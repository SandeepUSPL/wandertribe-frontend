			...
			<center>
				<ul class="list-inline" style="position: relative;">
					...
					<li class="active">
						...
						<div>
							<select class="item-info" name="destination"  id="destination">
								...
								<option value="Tirthan Valley">Tirthan Valley</option>0
							</select>
						</div>
					...
					<li>
							...
							<h5> Check-in</h5>
							<input type="text" name="date-in" placeholder="month/date/year" class="calendar-default item-info" id="from_date">
					</li>
					<li>
							<img src="new_img/icons/check-out.png" alt="">
							<h5> Check-out</h5>
							<input type="text" placeholder="month/date/year" name="date-out" class="calendar-default item-info" id="to_date">
					</li>
					<li>
					...
					<br><br>
					<div class="search"><button class="btn btn-warning" onclick="search_query()">SEARCH NOW</button> </div>
				</ul>
			</center>
		</div>
	</div>
...
<!--                    </div>-->
    ...
    <div class="container destination-map">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <img src="new_img/icons/circle.png" id="kashmirImg" onclick="search_query('NULL', 'JAMMU AND KASHMIR')" style="border-radius: 50%; cursor: pointer;"; >
                <img src="new_img/icons/circle.png" id="lehImg" onclick="search_query('NULL', 'LEH')" style="border-radius: 50%;cursor: pointer;">
                <img src="new_img/icons/circle.png" id="himachalImg"  onclick="search_query('NULL', 'HIMACHAL PRADESH')" style="border-radius: 50%;cursor: pointer;">
                <img src="new_img/icons/circle.png" id="uttarakhandImg" onclick="search_query('NULL', 'UTTARAKHAND')" style="border-radius: 50%;cursor: pointer;">
                <img src="new_img/icons/circle.png" id="punjabImg" onclick="search_query('NULL', 'PUNJAB')" style="border-radius: 50%;cursor: pointer;">
                <img src="new_img/icons/circle.png" id="delhiImg" onclick="search_query('NULL', 'DELHI')" style="border-radius: 50%;cursor: pointer;">
            </div>
            <div class="col-sm-4">
...
<div class="loan">
	...
	<img src="new_img/loan-apply.png">
</div>
<!--common footer-->
...
<script type="text/javascript">
    ...
    function search_query(type = "NULL", dest = "") {
        ...
        if (dest != "") {
        	var dest1 = dest.includes('%20')===true ? dest.replace('%20', ' ') : dest;
        ...
        if ($("#destination").val() == "" || $("#destination").val() == "undefined") {
            ...
            // console.log(document.getElementById('destination').value == "" ? dest : document.getElementById('destination').value);
            var destVal = document.getElementById('destination').value;
            //window.location ="https://www.wandertribe.in/search.php";
