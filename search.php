...
<div class="content-body">
    <div class="row">
        ...
        <div id="prices" class="container mb-50 mt-40">
            ...
            <!-- The Modal -->
            <div id="beat_price" class="modal">

                <!-- Modal content -->
                <div class="modal-content row">
                    <span class="close" onclick="close_modal(this)">&times;</span>
                    <div class="col-lg-12 text-center">
                        <h3>Beat the Price</h3>
                        <h6>for</h6>
                        <h5 id="bestprice_camp_name"></h5>
                    </div>
                    <div class="col-lg-12">
                        <form action="" id="bp_form" enctype="multipart/form-data">
                            <input type="hidden" name="camp_id" id="bp_camp_id">
                            <input type="hidden" name="camp_name" id="bp_camp_name">
                            <input type="hidden" name="our_price" id="bp_our_price">
                            <div class="form-group">
                                <lable>Name</lable>
                            ...
                            <div class="form-group">
                                <lable>ScreenShot</lable>
                                <input type="file" name="image" class="form-control" required>
                            </div>
                            <div class="form-group text-center">
                                <input type="submit" class="form-control cws-button small  alt mb-0 bg-orangish" style="width: 50%;  border-radius: 10px" value="SUBMIT">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <script>
                ...
                //     $.ajax({
                //         type: 'POST',
                //         url: 'https://api.tripvenza.com/api/login',
                //         data: {
                ...
                $(document).ready(function get_camplist() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            destination_name: "<?php echo $_GET['destination_name'];?>",
                            from_date: '<?php echo $_GET['from_date'];?>',
                            to_date: '<?php echo $_GET['to_date'];?>',
                            booking_required: <?php echo $_GET['booking_required'];?>,
                            queryType: <?php echo $_GET['type'];?>
                        },
                        dataType: 'json',
...
// alert(JSON.stringify(camps[property]));
            ...
            <script>
                ...
                function display_camp_list(lst) {
                    ...
                    if (lst.length > 0) {
                        ...
                        $.each(lst, function (index, india) {
                            ...
                            if (india.camp.camp_image.length == 0) {
                                return;
                            }

                            var temp_img = [];
                            $.each(india.camp.camp_image, function (index, value) {
                            ...
                            hotel += '<div class="recom-item col-md-12">\n' +
                                '                        <div class="recom-item-img col-md-8">\n' +
                                '                            <img id="camp_image' + index + '" src="' + india.camp.camp_image[0].imageUrl + '">\n' +
                                ...
                                '                            <div class="font-color">Starts from</div>\n' +
                                '                            <div class="font-color camp-price">₹ ' + india.camp.price + '</div>\n' +
                                '            </div>\n' +
                                ...
                                '            </div>' +
                                '                            <div class="col-md-12 camp-code font-color">' + india.camp.camp_name + '</div>\n' +
                                '                            <div class="col-md-12 camp-location">' + india.camp.location + '</div>\n' +
                                // '                            <div class="camp-ratings">\n' +
                                ...
                                '                    <button class="cws-button small  alt mb-0 bg-orangish"\n' +
                                '                            style="width: 90%;  border-radius: 10px";" onclick="camp_detail(\'' + indx + '\')">Get Details\n' +
                                '                    </button>\n' +
                                '                </div>\n' +
                                '    <div class="col-md-12 mb-0 pb-0 text-center">\n' +
                                '                    <img src="img/beatprice.png" \n' +
                                '                            style="width: 60%;" onclick="beat_the_price(\'' + indx + '\')">\n' +
                                '                </div>\n' +
                                '                        </div>\n' +
                                '                    </div>';
                ...
                function beat_the_price(iodex) {

                    $("#bestprice_camp_name").html(camps[iodex].camp.camp_name);
                    $("#bp_camp_name").val(camps[iodex].camp.camp_name);
                    $("#bp_camp_id").val(camps[iodex].camp.camp_id);
                    $("#bp_our_price").val(camps[iodex].camp.price);

                    $("#beat_price").show();

                }

                $('#bp_form').submit(function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://api.wandertribe.in/api/low_price_guarantee',
                        ...
                        success: function (data, textStatus, xhr) {
                            ...
                            if (xhr.status == 200) {
                               alert("Response submitted successfully");
                                ...
                                alert("Some error occured. Please Submit data again")
                            }
                        },
