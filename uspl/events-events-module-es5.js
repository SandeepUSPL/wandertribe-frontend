...
var EventcheckoutComponent = /** @class */ (function () {
    function EventcheckoutComponent(fb, route, http, store, demandStore, toast) {
        this.fb = fb;
        this.route = route;
        this.http = http;
        this.store = store;
    ...
    EventcheckoutComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.demandStore.select('demand').subscribe(function (demandState) {
            if (demandState.eventDemand.activeEvent) {
                _this.activeEvent = demandState.eventDemand.activeEvent;
            }
            if (demandState.eventDemand.selectedDetails) {
                _this.selectedPersonDetails = demandState.eventDemand.selectedDetails;
            }
    ...
    EventcheckoutComponent.prototype.onSubmit = function () {
    ...
    EventcheckoutComponent.prototype.getUserDetails = function (val) {
        var _this = this;
        if (val > 5999999999) {
    ...
    EventcheckoutComponent.ctorParameters = function () { return [
...
var EventdetailsComponent = /** @class */ (function () {
    function EventdetailsComponent(store, router, route, fb, http) {
        this.store = store;
        this.router = router;
        this.route = route;
        this.fb = fb;
    ...
    EventdetailsComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            if (params.get('id')) {
                ...
                _this.store.dispatch(new _store_demand_actions__WEBPACK_IMPORTED_MODULE_6__["TryFetchEvent"]({ _id: _this.id }));
        ...
        this.store.select('demand').subscribe(function (demandState) {
            if (demandState.eventDemand.activeEvent) {
                _this.activeEvent = demandState.eventDemand.activeEvent;
                _this.eventBannerImages = demandState.eventDemand.activeEvent.eventImage;
                if (demandState.eventDemand.activeEvent.similarEvents.length > 0) {
                    demandState.eventDemand.activeEvent.similarEvents.forEach(function (event) {
                        _this.similarEvent.push(event);
                    });
                }
                console.log(_this.similarEvent);
            }
        });
    };
    EventdetailsComponent.prototype.adultControl = function (x) {
        if (!(this.adult < 2 && x < 0)) {
            this.adult += x;
        }
    ...
    EventdetailsComponent.prototype.childControl = function (x) {
    ...
    EventdetailsComponent.prototype.getPricing = function () {
        var _this = this;
        this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_7__["eventPricing"], this.queryForm.value, { observe: 'response' }).subscribe(function (response) {
            if (response.status === 200) {
                _this.finalPrice = response.body;
            }
        });
    };
    EventdetailsComponent.prototype.selectedDatesIndexFunction = function (val) {
        this.selectedDatesIndex = val;
    };
    EventdetailsComponent.prototype.onSubmitQueryForm = function () {
...
var EventlistComponent = /** @class */ (function () {
    function EventlistComponent(store, route, router, http) {
        this.store = store;
        this.route = route;
        this.router = router;
        this.http = http;
    ...
    EventlistComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["eventQuery"], this.requestData, { observe: 'response' }).subscribe(function (response) {
            if (response.status === 200) {
                _this.store.dispatch(new _store_demand_actions__WEBPACK_IMPORTED_MODULE_6__["SetAllEvent"](response.body));
            }
        });
        this.isSearched = false;
        this.eventSubscription = this.store.select('demand').subscribe(function (demandState) {
            if (demandState.eventDemand.allEvents) {
                _this.allEvents = [];
                demandState.eventDemand.allEvents.forEach(function (event) {
                    _this.allEvents.push(event);
                });
            }
        });
    };
    EventlistComponent.prototype.searchList = function () {
        this.isSearched = true;
        console.log(this.allEvents);
    };
    EventlistComponent.prototype.navigateToEventDetail = function (id) {
...
var AddeventsComponent = /** @class */ (function () {
    function AddeventsComponent(router, fb, calendar, formatter, store, route, toastService) {
        this.router = router;
        this.fb = fb;
    ...
    AddeventsComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('events').subscribe(function (eventState) {
            if (!_this.editMode) {
                if (eventState.activeEvent) {
                    _this.finalEvent = eventState.activeEvent;
                    if (eventState.activeEvent.eventDayDetails) {
                        _this.eventDaysArray = eventState.activeEvent.eventDayDetails;
                    }
                }
            }
        });
        ...
        this.route.paramMap.subscribe(function (params) {
            if (params.get('id')) {
                _this.editMode = true;
                _this.id = +params.get('id');
                _this.store.select('events').subscribe(function (eventState) {
                    _this.finalEvent = eventState.events[_this.id];
                    if (_this.finalEvent) {
                        _this.basicForm.patchValue(_this.finalEvent);
                        _this.settingForm.patchValue(_this.finalEvent);
                        _this.finalEvent.eventDayDetails.forEach(function (value) {
                            _this.eventDayDetails.push(_this.addEventDayDetailGroup(value));
                        });
                        _this.eventForm.setValue(_this.eventDayDetails.value[0]);
                    }
                    else {
                        _this.router.navigate(['../../manageEvent'], { relativeTo: _this.route });
                    }
                });
            }
        });
    };
    AddeventsComponent.prototype.addEventDayDetailGroup = function (value) {
    ...
    AddeventsComponent.prototype.onDateSelection = function (date) {
    ...
    AddeventsComponent.prototype.isHovered = function (date) {
        return this.fromDate && !this.toDate && this.hoveredDate && date.after(this.fromDate) && date.before(this.hoveredDate);
    };
    AddeventsComponent.prototype.isInside = function (date) {
        return date.after(this.fromDate) && date.before(this.toDate);
    };
    AddeventsComponent.prototype.isRange = function (date) {
        return date.equals(this.fromDate) || date.equals(this.toDate) || this.isInside(date) || this.isHovered(date);
    };
    AddeventsComponent.prototype.validateInput = function (currentValue, input) {
    ...
    AddeventsComponent.prototype.addEventDate = function () {
        var x = {
    ...
    AddeventsComponent.prototype.removeEventDate = function (i) {
        this.basicForm.controls["eventDates"].removeAt(i);
    };
    AddeventsComponent.prototype.imgPreviewEventDay = function (fileInput) {
        var _this = this;
        this.eventDayImg = fileInput.target.files[0];
        var mimeType = this.eventDayImg.type;
        ...
        reader.onload = function () {
            _this.imgPreviewUrlEventDay = reader.result;
        };
    };
    AddeventsComponent.prototype.imgPreviewEvent = function (fileInput) {
        var e_1, _a;
        var _this = this;
            ...
            try {
                for (var files_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](files), files_1_1 = files_1.next(); !files_1_1.done; files_1_1 = files_1.next()) {
                    ...
                    reader.onload = function (e) {
                        _this.settingForm.get('eventImage').push(_this.fb.group({
                            url: e.target.result
                        }));
                    };
    ...
    AddeventsComponent.prototype.setEventDay = function (it) {
        this.currentDay = it;
    ...
    AddeventsComponent.prototype.basicFormSubmit = function () {
    ...
    AddeventsComponent.prototype.eventFormSubmit = function () {
    ...
    AddeventsComponent.prototype.settingFormSubmit = function () {
        this.dispatch(this.settingForm.value);
        if (this.eventImgArray.length) {
            var data_1 = new FormData();
            data_1.append('_id', this.finalEvent._id);
            Array.from(this.eventImgArray).forEach(function (image) {
                data_1.append('eventImage[]', image);
            });
            this.store.dispatch(new _store_events_actions__WEBPACK_IMPORTED_MODULE_8__["TryUploadEventImage"](data_1));
        }
        this.router.navigate(['../manageEvent'], { relativeTo: this.route });
    };
    AddeventsComponent.prototype.dispatch = function (obj) {
...
var EventsModel = /** @class */ (function () {
    function EventsModel(_id, todoPlan, category, location, eventDates, totalDays, languages, difficultyLevel, ownerDescription, naturalDisasterResponsePlan, emergencyResponsePlan, medicalResponsePlan, cancellationPolicy, eventDayDetails, eventImage, provided, carry, pricePerPerson, minPeople, maxPeople, eventTitle, delFlg) {
        this._id = _id;
    ...
    EventsModel.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var ManageeventsComponent = /** @class */ (function () {
    function ManageeventsComponent(router, route, store) {
        this.router = router;
        this.route = route;
        this.store = store;
    }
    ManageeventsComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('events').subscribe(function (eventState) {
            return _this.events = eventState.events;
        });
    };
    ManageeventsComponent.prototype.editEvent = function (index) {
        this.router.navigate(['../editEvent', index], { relativeTo: this.route });
    };
    ManageeventsComponent.prototype.deleteEvent = function (index) {
    ...
    ManageeventsComponent.ctorParameters = function () { return [
...
var TRY_SAVE_EVENT = 'TRY_SAVE_EVENT';
var TRY_FETCH_EVENTS = 'TRY_FETCH_EVENTS';
var TRY_UPLOAD_EVENT_IMAGE = 'TRY_UPLOAD_EVENT_IMAGE';
var SET_EVENTS = 'SET_EVENTS';
var SET_ACTIVE_EVENT = 'SET_ACTIVE_EVENT';
var TryUploadEventImage = /** @class */ (function () {
    function TryUploadEventImage(payload) {
        this.payload = payload;
        this.type = TRY_UPLOAD_EVENT_IMAGE;
    }
    TryUploadEventImage.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return TryUploadEventImage;
}());

var TryFetchEvents = /** @class */ (function () {
    function TryFetchEvents() {
        this.type = TRY_FETCH_EVENTS;
    }
    return TryFetchEvents;
}());

var TrySaveEvent = /** @class */ (function () {
    function TrySaveEvent(payload) {
        this.payload = payload;
        this.type = TRY_SAVE_EVENT;
    }
    TrySaveEvent.ctorParameters = function () { return [
        { type: _events_model__WEBPACK_IMPORTED_MODULE_0__["EventsModel"] }
    ]; };
    return TrySaveEvent;
}());

var SetEvents = /** @class */ (function () {
    function SetEvents(payload) {
        this.payload = payload;
        this.type = SET_EVENTS;
    }
    SetEvents.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return SetEvents;
}());
...
var EventsEffects = /** @class */ (function () {
    function EventsEffects(action, http) {
        var _this = this;
        this.action = action;
        this.http = http;
        this.uploadImage = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_events_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_UPLOAD_EVENT_IMAGE"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["uploadEventImage"], data, { observe: 'response' });
        ...
        this.editEvent = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_events_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_SAVE_EVENT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["saveEvent"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchEvents = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_events_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_FETCH_EVENTS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function () {
            return _this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["fetchEvents"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (response) {
            if (response.status === 200) {
...
function EventsReducer(state, action) {
    ...
    switch (action.type) {
        case 'SET_ACTIVE_EVENT': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { activeEvent: action.payload });
        }
        case 'SET_EVENTS': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { events: action.payload });
        }
        default: {
