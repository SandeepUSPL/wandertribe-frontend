...
var FinanceModel = /** @class */ (function () {
    function FinanceModel(name, registrationType, registrationNo, registrationNoProof, officeAddress, registrationAuthority, registrationMsmeNumber, gstNumber, panNumber, unionEnrollmentNumber, firmAddress, ownerDetails, registrationCinProof, gstNumberProof, registrationMsmeNumberProof) {
        this.name = name;
    ...
    FinanceModel.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var FinanceeditComponent = /** @class */ (function () {
    function FinanceeditComponent(fb, store) {
        this.fb = fb;
        this.store = store;
    ...
    FinanceeditComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.store.select('finance').subscribe(function (value) {
            console.log(value);
            _this.financeStore = value.finance;
            _this.previewUrlCinProof = value.finance.registrationCinProof;
            _this.previewUrlgstNumber = value.finance.gstNumberProof;
            _this.previewUrlregistrationMsmeNumber = value.finance.registrationMsmeNumberProof;
            _this.editForm.patchValue(_this.financeStore);
            _this.imageForm.patchValue(_this.financeStore);
            _this.ownerForm.patchValue(_this.financeStore);
        });
    };
    FinanceeditComponent.prototype.imgPreviewregistrationMsmeNumber = function (fileInput) {
        var _this = this;
    ...
    FinanceeditComponent.prototype.imgPreviewgstNumber = function (fileInput) {
        var _this = this;
    ...
    FinanceeditComponent.prototype.imgPreviewaddress = function (fileInput) {
        var _this = this;
    ...
    FinanceeditComponent.prototype.onSubmit = function (type) {
        if (type === 'imageForm') {
    ...
    FinanceeditComponent.ctorParameters = function () { return [
...
var TRY_FETCH_FINANCE = 'TRY_FETCH_FINANCE';
var SET_FINANCE = 'SET_FINANCE';
var FINANCE_EDIT = 'FINANCE_EDIT';
var UPLOAD_FINANCE_IMAGES = 'UPLOAD_FINANCE_IMAGES';
// classes for finance
var TryFetchFinance = /** @class */ (function () {
    function TryFetchFinance() {
        this.type = TRY_FETCH_FINANCE;
    }
    return TryFetchFinance;
}());

var SetFinance = /** @class */ (function () {
    function SetFinance(payload) {
        this.payload = payload;
        this.type = SET_FINANCE;
    }
    SetFinance.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SetFinance;
}());

var UploadFinanceImages = /** @class */ (function () {
    function UploadFinanceImages(payload) {
        this.payload = payload;
        this.type = UPLOAD_FINANCE_IMAGES;
    }
    UploadFinanceImages.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UploadFinanceImages;
}());

var FinanceEdit = /** @class */ (function () {
    function FinanceEdit(payload) {
        this.payload = payload;
        this.type = FINANCE_EDIT;
    }
    FinanceEdit.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return FinanceEdit;
}());
...
var FinanceEffects = /** @class */ (function () {
    function FinanceEffects(action, http) {
        var _this = this;
        this.action = action;
        this.http = http;
        // effects for finance
        this.editFinance = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_finance_actions__WEBPACK_IMPORTED_MODULE_6__["FINANCE_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (payload) {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["editfinance"], data, { observe: 'response' });
        ...
        this.uploadFinanceImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_finance_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_FINANCE_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadfinanceImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchFinance = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_finance_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_FINANCE"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () {
            return _this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchfinance"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
    ...
    FinanceEffects.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _finance_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../finance.model */ "./src/app/roles/business/finance/finance.model.ts");


var initialState = {
    finance: new _finance_model__WEBPACK_IMPORTED_MODULE_1__["FinanceModel"]('', '', '', '', '', '', '', '', '', '', {
        permanentAddress: {
            address: '',
            pincode: '',
            phoneNo: ''
...
function FinanceReducer(state, action) {
    ...
    switch (action.type) {
        case 'SET_FINANCE': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { finance: action.payload });
        }
        default: {
