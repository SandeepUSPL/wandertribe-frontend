...
let JoblistComponent = class JoblistComponent {
    ...
    ngOnInit() {
        this.store.select('jobs').subscribe(value => {
            console.log(value);
...
let JobsComponent = class JobsComponent {
    constructor(store, sidebarService) {
        this.store = store;
...
class JobsModel {
    constructor(_id, jobType, jobTitle, startDate, location, commission, email, skills, description, experience, postedBy) {
        this._id = _id;
...
let PostjobComponent = class PostjobComponent {
    constructor(fb, route, store, router) {
        ...
        this.search = (text$) => text$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(term => term.length < 1 ? []
            : this.skillSet.filter(v => v.toLowerCase().indexOf(term.toLowerCase()) > -1)));
    }
    ngOnInit() {
        this.store.select('jobs').subscribe(value => {
            this.jobs = value.jobs;
        ...
        this.route.paramMap.subscribe((params) => {
            if (params.get('id')) {
                ...
                this.editMode = true;
                this.jobForm.patchValue(this.jobs[this.id]);
            }
        });
    }
    removeSkill(index) {
    ...
    addSkill(skl) {
        const obj = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](skl);
        if (skl.length > 0) {
...
const TRY_FETCH_JOBS = 'TRY_FETCH_JOBS';
const TRY_ADD_JOBS = 'TRY_ADD_JOBS';
const TRY_EDIT_JOB = 'TRY_EDIT_JOB';
const TRY_DELETE_JOB = 'TRY_DELETE_JOB';
...
let JobsEffects = class JobsEffects {
    constructor(action, http) {
        this.action = action;
        this.http = http;
        this.addJob = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_jobs_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_ADD_JOBS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["newJob"], data, { observe: 'response' });
        ...
        this.fetchAllJobs = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_jobs_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_FETCH_JOBS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["fetchJobByUser"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.deleteJob = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_jobs_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_DELETE_JOB"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["editJob"], { _id: data, delFlg: 'Y' }, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.editJob = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_jobs_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_EDIT_JOB"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["editJob"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
...
function JobsReducer(state = initialState, action) {
    switch (action.type) {
        case 'SET_JOBS': {
            ...
            return Object.assign({}, state, { jobs: finalJob });
        }
        default: {
