...
var appRoutes = [
    ...
    {
        path: 'roles', loadChildren: function () { return __webpack_require__.e(/*! import() | roles-role-module */ "roles-role-module").then(__webpack_require__.bind(null, /*! ./roles/role.module */ "./src/app/roles/role.module.ts")).then(function (module) { return module.RoleModule; }); }
    },
    {
        path: 'd', loadChildren: function () { return __webpack_require__.e(/*! import() | demand-demand-module */ "demand-demand-module").then(__webpack_require__.bind(null, /*! ./demand/demand.module */ "./src/app/demand/demand.module.ts")).then(function (module) { return module.DemandModule; }); }
    },
...
var AuthGuardService = /** @class */ (function () {
    ...
    AuthGuardService.prototype.isAuthorized = function () {
        return this.store.select('authState').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (authState) {
...
var ForgotpasswordComponent = /** @class */ (function () {
    function ForgotpasswordComponent(store, authService) {
        this.store = store;
    ...
    ForgotpasswordComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.mobileCheck = this.authService.loginMobileCheckToken.subscribe(function (value) {
            if (value === true) {
                _this.isMobileVerified = true;
            }
            else {
                _this.mobileCheckToken = true;
            }
        });
        this.otpCheck = this.authService.loginOtpCheckToken.subscribe(function (value) {
            if (value === true) {
                _this.isOtpVerified = true;
            }
            else {
                _this.otpCheckToken = true;
            }
        });
    };
    ForgotpasswordComponent.prototype.verifymobile = function (form) {
    ...
    ForgotpasswordComponent.prototype.verifyotp = function (form) {
        var otp = (+form.value.otp1) + '' + (+form.value.otp2) + '' + (+form.value.otp3) + '' + (+form.value.otp4);
        this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_4__["VerifyOtp"]({ mobile: this.mobile, otp: +otp }));
    };
    ForgotpasswordComponent.prototype.changepassword = function (form) {
    ...
    ForgotpasswordComponent.prototype.keytab = function (event) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.mobileCheck = this.authService.loginMobilePageToken.subscribe(function (value) {
            if (value === false) {
                _this.mobileCheckToken = true;
            }
        });
...
var MobileverifyComponent = /** @class */ (function () {
    function MobileverifyComponent(store, authService, route) {
        this.store = store;
        this.authService = authService;
        this.route = route;
        this.mobileCheckToken = false;
    ...
    MobileverifyComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params["auth_key"]) {
                _this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_4__["SetToken"](params["auth_key"]));
                _this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_4__["TryAuthSignIn"]());
            }
            else {
                _this.profileData.name = params["name"];
                _this.profileData.email = params["email"];
                Object.assign(_this.profileData, _this.role);
    ...
    MobileverifyComponent.prototype.verifymobile = function (form) {
        this.mobile = form.value.mobile;
        this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_4__["SendOtp"]({ type: 'socialMedia', mobile: this.mobile }));
    };
    MobileverifyComponent.prototype.verifyotp = function (form) {
        var otp = (+form.value.otp1) + '' + (+form.value.otp2) + '' + (+form.value.otp3) + '' + (+form.value.otp4);
        this.store.dispatch(new _store_auth_actions__WEBPACK_IMPORTED_MODULE_4__["VerifyOtp"]({ mobile: this.mobile, otp: +otp }));
    };
    MobileverifyComponent.prototype.signUp = function () {
    ...
    MobileverifyComponent.prototype.keytab = function (event) {
        var element = event.srcElement.nextElementSibling; // get the sibling element
        if (element == null) {
            return;
        }
    ...
    MobileverifyComponent.prototype.ngOnDestroy = function () {
        this.otpCheck.unsubscribe();
        this.mobileCheck.unsubscribe();
    };
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(store, authService) {
        this.store = store;
        this.authService = authService;
    ...
    SignupComponent.prototype.ngOnInit = function () {
        ...
        this.mobileCheck = this.authService.signupMobileCheckToken.subscribe(function (value) {
            if (value === true) {
                _this.mobileCheckToken = true;
            }
        });
...
var FETCH_SIGNUP_FIELDS = 'FETCH_SIGNUP_FIELDS';
var TRY_SIGNIN = 'TRY_SIGNIN';
var TRY_AUTH_SIGNIN = 'TRY_AUTH_SIGNIN';
var TRY_SIGNUP = 'TRY_SIGNUP';
var SIGNIN = 'SIGNIN';
var LOGOUT = 'LOGOUT';
var SET_TOKEN = 'SET_TOKEN';
var TRY_PROFILE_EDIT = 'TRY_PROFILE_EDIT';
...
var UploadImages = /** @class */ (function () {
    function UploadImages(payload) {
        this.payload = payload;
        this.type = UPLOAD_IMAGES;
    }
    UploadImages.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UploadImages;
}());
...
var SetPassword = /** @class */ (function () {
    ...
    SetPassword.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SetPassword;
}());
...
var VerifyOtp = /** @class */ (function () {
    ...
    VerifyOtp.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return VerifyOtp;
}());

var SendOtp = /** @class */ (function () {
    function SendOtp(payload) {
        this.payload = payload;
        this.type = SEND_OTP;
    }
    SendOtp.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SendOtp;
}());

var SetProfile = /** @class */ (function () {
    function SetProfile(payload) {
        this.payload = payload;
        this.type = SET_PROFILE;
    }
    SetProfile.ctorParameters = function () { return [
        { type: _core_model_profile_model__WEBPACK_IMPORTED_MODULE_0__["ProfileModel"] }
    ]; };
    return SetProfile;
}());

var TryProfileEdit = /** @class */ (function () {
    function TryProfileEdit(payload) {
        this.payload = payload;
        this.type = TRY_PROFILE_EDIT;
    }
    TryProfileEdit.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return TryProfileEdit;
}());

var FetchSignupFields = /** @class */ (function () {
    function FetchSignupFields(payload) {
        this.payload = payload;
        this.type = FETCH_SIGNUP_FIELDS;
    }
    FetchSignupFields.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return FetchSignupFields;
}());
...
var TrySignUp = /** @class */ (function () {
    ...
    TrySignUp.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return TrySignUp;
}());
...
var TrySignIn = /** @class */ (function () {
    ...
    TrySignIn.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return TrySignIn;
}());

var TryAuthSignIn = /** @class */ (function () {
    function TryAuthSignIn() {
        this.type = TRY_AUTH_SIGNIN;
    }
    return TryAuthSignIn;
}());
...
var SetToken = /** @class */ (function () {
    ...
    SetToken.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SetToken;
}());
...
var AuthEffects = /** @class */ (function () {
    function AuthEffects(action, store, http, router, authService, toastService) {
        var _this = this;
        this.action = action;
        this.store = store;
        this.http = http;
        ...
        this.uploadImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["UPLOAD_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["uploadProfileImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Images uploaded successfully!');
                return [
                    {
        ...
        this.setPassword = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["SET_PASSWORD"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["changePassword"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Your password is updated, Please login!');
                _this.router.navigate(['/login']);
                return [];
            }
        }));
        this.verifyOtp = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["VERIFY_OTP"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["verifyOtp"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('OTP verified successfully!');
                _this.authService.loginOtpCheckToken.next(true);
                return [];
            }
            else {
                _this.authService.loginOtpCheckToken.next(false);
                return [];
            }
        }));
        this.sendOtp = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["SEND_OTP"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["sendOtp"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('OTP sent successfully!');
                _this.authService.loginMobileCheckToken.next(true);
                return [];
            }
            else if (response.status === 203) {
                _this.toastService.showSuccess('User already Found!');
                _this.authService.loginMobileCheckToken.next(false);
                return [];
            }
            else {
                _this.authService.loginMobileCheckToken.next(false);
        ...
        // for profile edit
        this.profileEdit = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_PROFILE_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (action) {
            return action.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["editProfile"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Your Profile is updated Successfully!');
                return [
                    {
                        type: _auth_actions__WEBPACK_IMPORTED_MODULE_4__["SET_PROFILE"],
                        payload: response.body
        ...
        // for signing up
        this.authSignUp = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_SIGNUP"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (action) {
            return action.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["signupUrl"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Welcome to Unfoldingskies!');
                ...
                _this.authService.signupMobileCheckToken.next(true);
            }
        }));
        // for log out
        this.authLogout = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["LOGOUT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () {
            window.location.href = '/';
        }));
        // for signup using social media where authkey is used to signin
        this.authSignIn = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_AUTH_SIGNIN"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["authSignIn"], {}, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.router.navigate(['/profile']);
                return [
        ...
        // for signing in
        this.signIn = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_4__["TRY_SIGNIN"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (action) {
            return action.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["loginUrl"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (response) {
            if (response.status === 200) {
                ...
                _this.authService.loginMobilePageToken.next(false);
                return [];
            }
        }));
    }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _core_model_profile_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../core/model/profile.model */ "./src/app/core/model/profile.model.ts");
...
var initialState = {
    ...
    profile: localStorage.getItem('Authorization') ? Object.assign(new _core_model_profile_model__WEBPACK_IMPORTED_MODULE_1__["ProfileModel"](), profile) : new _core_model_profile_model__WEBPACK_IMPORTED_MODULE_1__["ProfileModel"]()
};
function AuthReducer(state, action) {
    ...
    switch (action.type) {
        case 'SET_PROFILE': {
            ...
            var profileObject = action.payload;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { profile: profileObject });
        }
        case 'SIGNIN': {
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(store, router, toastService) {
        this.store = store;
        this.router = router;
        this.toastService = toastService;
    }
    ...
    HeaderComponent.prototype.isTemplate = function (toast) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(store, router, fb, http, toastService, modalService) {
        this.store = store;
        this.router = router;
        this.fb = fb;
        this.http = http;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('authState').subscribe(function (auth) {
            _this.authenticated = auth.authenticated;
    ...
    HomeComponent.prototype.onSearch = function (form) {
        var data = {
    ...
    HomeComponent.prototype.redirectDestination = function (dest) {
    ...
    HomeComponent.prototype.setToDate = function () {
    ...
    HomeComponent.prototype.hotelMigrate = function () {
        if (this.authenticated) {
            var url = 'https://hotels.wandertribe.in/index.php?auth_key=' + this.token;
            url = url.replace(/"/g, '');
            // console.log(url);
    ...
    HomeComponent.prototype.contactFormSubmit = function () {
        var _this = this;
        this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_8__["contactUs"], this.contactUserForm.value, { observe: 'response' }).subscribe(function (value) {
            _this.offerContact = false;
            if (value.status === 200) {
                _this.toastService.showSuccess('Your response recorded successfully!');
            }
            else {
                _this.toastService.showDanger('Some error occurred!!');
            }
        });
    };
...
var ProfileModel = /** @class */ (function () {
    function ProfileModel(roles, _id, name, mobile, email, address, dob, profileImage, dobImage, addressImage) {
        this.roles = roles;
        this._id = _id;
        this.name = name;
        this.mobile = mobile;
    ...
    ProfileModel.ctorParameters = function () { return [
        { type: undefined },
        { type: String },
        { type: String },
        { type: String },
...
var OrdersComponent = /** @class */ (function () {
    function OrdersComponent(pipe, http, toastService) {
        var _this = this;
        this.http = http;
        this.toastService = toastService;
        this.filter = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('');
        this.orders = this.filter.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (text) { return _this.search(text, pipe); }));
    }
    OrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["getBookings"], { observe: 'response' }).subscribe(function (response) {
            if (response.status === 200) {
                _this.initialOrders = [];
                response.body.forEach(function (order) {
                    _this.initialOrders.push(order);
                });
                console.log(_this.initialOrders);
            }
            else {
                _this.toastService.showDefault('No Orders found! Thanks');
            }
        });
    };
    //
    //
    OrdersComponent.prototype.search = function (text, pipe) {
        return this.initialOrders.filter(function (order) {
...
var ProfileeditComponent = /** @class */ (function () {
    function ProfileeditComponent(fb, store, authService, router) {
        this.fb = fb;
        this.store = store;
        this.authService = authService;
        this.router = router;
    ...
    ProfileeditComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('authState').subscribe(function (value) {
            Object.assign(_this.profileData, value.profile);
            // this.profileData = value.profile;
            console.log(_this.profileData);
            _this.profileForm.patchValue(value.profile);
            _this.previewUrlProfile = value.profile.profileImage ? value.profile.profileImage : _this.imgPreview;
            _this.previewUrlAddress = value.profile.addressImage ? value.profile.addressImage : _this.imgPreview;
            _this.previewUrlDob = value.profile.dobImage ? value.profile.dobImage : _this.imgPreview;
        });
    };
    ProfileeditComponent.prototype.set_address = function (adrs) {
        if (adrs) {
            var currentAddress = this.profileForm.get(['address', 'currentAddress']).value;
    ...
    ProfileeditComponent.prototype.imgPreviewProfile = function (fileInput) {
        var _this = this;
        ...
        reader.onload = function () {
            _this.previewUrlProfile = reader.result;
        };
        this.imageForm.controls.profileImage.patchValue(this.profileImage);
    };
    ProfileeditComponent.prototype.imgPreviewDob = function (fileInput) {
        var _this = this;
        this.dobProof = fileInput.target.files[0];
        var mimeType = this.dobProof.type;
        var reader = new FileReader();
        reader.readAsDataURL(this.dobProof);
        reader.onload = function () {
            if (mimeType.match(/image\/*/) == null) {
                _this.previewUrlDob = _this.fileUploadPreview;
            }
            else {
                _this.previewUrlDob = reader.result;
            }
        };
    };
    ProfileeditComponent.prototype.imgPreviewAddress = function (fileInput) {
        var _this = this;
        this.addressProof = fileInput.target.files[0];
        var reader = new FileReader();
        reader.readAsDataURL(this.addressProof);
        var mimeType = this.addressProof.type;
        reader.onload = function () {
            if (mimeType.match(/image\/*/) == null) {
                // if file type is not image
                _this.previewUrlAddress = _this.fileUploadPreview;
            }
            else {
                // if file type is image
                _this.previewUrlAddress = reader.result;
            }
        };
    ...
    ProfileeditComponent.prototype.onImageSubmit = function () {
    ...
    ProfileeditComponent.prototype.businessProfileSubmit = function (form) {
    ...
    ProfileeditComponent.prototype.activityExpertSubmit = function (form) {
    ...
    ProfileeditComponent.prototype.jobSeekerSubmit = function (form) {
        this.updateProfile(this.profileData.roles.jobBoard, form.value);
        this.router.navigate(['/roles/b/list']);
    };
    ProfileeditComponent.prototype.navigationTrigger = function () {
        this.navigationCheck = true;
    };
    ProfileeditComponent.prototype.updateProfile = function (obj1, obj2) {
...
var ProfileviewComponent = /** @class */ (function () {
    function ProfileviewComponent(store, authService) {
        this.store = store;
        this.authService = authService;
    ...
    ProfileviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select('authState').subscribe(function (value) {
            _this.profileData = value.profile;
            _this.profileImage = _this.profileData.profileImage === '' ? '../../../assets/icons/user.png' : _this.profileData.profileImage;
        });
    };
...
var ActiveClassDirective = /** @class */ (function () {
    ...
    ActiveClassDirective.prototype.toggleOpen = function () {
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        return this.store.select('authState').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (authState) {
            var token = authState.token ? authState.token : '';
            var cloneReq = req.clone({ headers: req.headers.append('Authorization', token) });
...
var CamelToSentanceCasePipe = /** @class */ (function () {
    function CamelToSentanceCasePipe() {
    }
    CamelToSentanceCasePipe.prototype.transform = function (value) {
    ...
    return CamelToSentanceCasePipe;
}());
...
var ResponseIntercept = /** @class */ (function () {
    function ResponseIntercept(store, toastService) {
        this.store = store;
        this.toastService = toastService;
    }
    ResponseIntercept.prototype.intercept = function (req, next) {
        var _this = this;
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (event) {
            ...
            if (e instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"] && e.status === 401) {
                _this.toastService.showDanger('Unauthorized Request !! You will be logged out now.');
                setTimeout(function () {
                    _this.store.dispatch(new _auth_store_auth_actions__WEBPACK_IMPORTED_MODULE_3__["LogOut"]());
                }, 3000);
            }
        }));
    };
    ResponseIntercept.ctorParameters = function () { return [
...
var genericUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl;
var fbLogin = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].webUrl + 'socialMediaRedirect/facebook';
var googleLogin = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].webUrl + 'socialMediaRedirect/google';
var newBooking = genericUrl + 'newBooking';
var loginUrl = genericUrl + 'login';
var authSignIn = genericUrl + 'authlogin';
var signupUrl = genericUrl + 'register';
var fetchRoleUrl = genericUrl + 'get_all_roles';
var fetchSingleRole = genericUrl + 'get_role';
var getUserByMobile = genericUrl + 'getUserByMobile';
var editRole = genericUrl + 'edit_user_roles';
var editProfile = genericUrl + 'edit_profile';
var changePassword = genericUrl + 'change_password';
// realestate routes
var editrealestate = genericUrl + 'realestate/edit_realestate';
var fetchrealestate = genericUrl + 'realestate/get_realestate';
var uploadrealestateImages = genericUrl + 'realestate/upload_images';
var saverealEstateProperty = genericUrl + 'realestate/save_property';
var uploadrealestatePropertyImages = genericUrl + 'realestate/upload_property_images';
var fetechrealestateProperties = genericUrl + 'realestate/fetch_all_properties';
// finance routes
var editfinance = genericUrl + 'finance/edit_finance';
var fetchfinance = genericUrl + 'finance/get_finance';
var uploadfinanceImages = genericUrl + 'finance/upload_images';
// servicesuppliers routes
var editservicesuppliers = genericUrl + 'servicesuppliers/edit_servicesuppliers';
var fetchservicesuppliers = genericUrl + 'servicesuppliers/get_servicesuppliers';
var uploadservicesuppliersImages = genericUrl + 'servicesuppliers/upload_images';
// travel curator routes
var edittravelcurator = genericUrl + 'travelcurator/edit_travelcurator';
var fetchtravelcurator = genericUrl + 'travelcurator/get_travelcurator';
var uploadtravelcuratorImages = genericUrl + 'travelcurator/upload_images';
// travel agent routes
var edittravelagent = genericUrl + 'travelagent/edit_travelagent';
var fetchtravelagent = genericUrl + 'travelagent/get_travelagent';
var uploadtravelagentImages = genericUrl + 'travelagent/upload_images';
// properties routes
var editProperties = genericUrl + 'properties/edit_properties';
var fetchProperties = genericUrl + 'properties/get_properties';
var uploadPropertiesImages = genericUrl + 'properties/upload_images';
// transportation routes
var editTransportation = genericUrl + 'transportation/edit_transportation';
var fetchTransportation = genericUrl + 'transportation/get_transportation';
var saveVehicles = genericUrl + 'transportation/save_vehicles';
var fetchVehicles = genericUrl + 'transportation/fetch_vehicles';
var uploadTransportationImages = genericUrl + 'transportation/upload_images';
var uploadVehicleImages = genericUrl + 'transportation/upload_vehicle_images';
var sendOtp = genericUrl + 'send_otp';
var verifyOtp = genericUrl + 'verify_otp';
// upload urls
var uploadProfileImages = genericUrl + 'upload_profile_images';
// jobs urls
var newJob = genericUrl + 'jobs/new_job';
var fetchJobByUser = genericUrl + 'jobs/get_by_user';
var editJob = genericUrl + 'jobs/edit_job';
// treks url
var saveTrek = genericUrl + 'treks/save_trek';
var fetchTreks = genericUrl + 'treks/fetch_by_user';
var uploadTrekImage = genericUrl + 'treks/upload_image';
var trekList = genericUrl + 'treks/trek_list';
var trekQuery = genericUrl + 'treks/trek_query';
var trekDetails = genericUrl + 'treks/trek_details';
var trekPricing = genericUrl + 'treks/getTrekPricing';
// road trip url
var saveRTrip = genericUrl + 'RTrips/save_RTrip';
var fetchRTrips = genericUrl + 'RTrips/fetch_by_user';
var uploadRTripImage = genericUrl + 'RTrips/upload_image';
var RTripQuery = genericUrl + 'RTrips/RTrip_query';
var RTripDetails = genericUrl + 'RTrips/RTrip_details';
var RTripPricing = genericUrl + 'RTrips/getRTripPricing';
// events url
var saveEvent = genericUrl + 'events/save_event';
var fetchEvents = genericUrl + 'events/fetch_by_user';
var uploadEventImage = genericUrl + 'events/upload_image';
var eventQuery = genericUrl + 'events/event_query';
var eventDetails = genericUrl + 'events/event_details';
var eventPricing = genericUrl + 'events/getEventPricing';
var contactUs = genericUrl + 'contact_us';
var getBookings = genericUrl + 'getBookings';
...
var ToastService = /** @class */ (function () {
    ...
    ToastService.prototype.showDefault = function (textOrTpl, options) {
        if (options === void 0) { options = {}; }
        this.toasts.push({ textOrTpl: textOrTpl, classname: 'bg-bluish text-light', delay: 3000 });
    };
    ToastService.prototype.showSuccess = function (textOrTpl) {
        this.toasts.push({ textOrTpl: textOrTpl, classname: 'bg-success text-light', delay: 4000 });
    };
    ToastService.prototype.showDanger = function (textOrTpl) {
        this.toasts.push({ textOrTpl: textOrTpl, classname: 'bg-danger text-light', delay: 5000 });
    };
