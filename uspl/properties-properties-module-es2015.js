...
let PropertiesRoutingModule = class PropertiesRoutingModule {
};
...
PropertiesModel.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
let PropertieseditComponent = class PropertieseditComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('properties').subscribe(value => {
            console.log(value);
            this.transportationStore = value.properties;
            this.previewUrlCinProof = value.properties.registrationCinProof;
            this.previewUrlgstNumber = value.properties.gstNumberProof;
            this.previewUrlregistrationMsmeNumber = value.properties.registrationMsmeNumberProof;
            this.editForm.patchValue(this.transportationStore);
            this.imageForm.patchValue(this.transportationStore);
            this.ownerForm.patchValue(this.transportationStore);
        });
    }
...
const TRY_FETCH_PROPERTIES = 'TRY_FETCH_PROPERTIES';
const PROPERTIES_EDIT = 'PROPERTIES_EDIT';
const UPLOAD_PROPERTIES_IMAGES = 'UPLOAD_PROPERTIES_IMAGES';
// classes for properties
class UploadPropertiesImages {
    constructor(payload) {
        this.payload = payload;
        this.type = UPLOAD_PROPERTIES_IMAGES;
    }
}
UploadPropertiesImages.ctorParameters = () => [
    { type: undefined }
];
...
PropertiesEdit.ctorParameters = () => [
    { type: undefined }
];
class TryFetchProperties {
    constructor() {
...
let PropertiesEffects = class PropertiesEffects {
    constructor(action, http) {
        this.action = action;
        this.http = http;
        // effects for properties
        this.uploadPropertiesImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_properties_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_PROPERTIES_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadPropertiesImages"], data, { observe: 'response' });
        ...
        this.editProperties = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_properties_actions__WEBPACK_IMPORTED_MODULE_6__["PROPERTIES_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((payload) => {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["editProperties"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchProperties = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_properties_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_PROPERTIES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchProperties"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
...
PropertiesEffects.ctorParameters = () => [
...
/* harmony import */ var _properties_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../properties.model */ "./src/app/roles/business/properties/properties.model.ts");

const initialState = {
    properties: new _properties_model__WEBPACK_IMPORTED_MODULE_0__["PropertiesModel"]('', '', '', '', '', '', '', '', '', '', {
        permanentAddress: {
            address: '',
            pincode: '',
            phoneNo: ''
