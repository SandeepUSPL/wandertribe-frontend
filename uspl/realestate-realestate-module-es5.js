...
var AddpropertyreComponent = /** @class */ (function () {
    function AddpropertyreComponent(fb, store, router, route, toastService) {
        this.fb = fb;
        this.store = store;
        this.router = router;
        this.route = route;
    ...
    AddpropertyreComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.store.select('realEstate').subscribe(function (value) {
            console.log(value);
            _this.realEstate = value.realEstate;
            if (value.property) {
        ...
        this.route.paramMap.subscribe(function (params) {
            if (params.get('id')) {
                ...
                _this.editMode = true;
                _this.property = _this.realEstate.properties[_this.id];
                _this.editForm.patchValue(_this.realEstate.properties[_this.id]);
                _this.pricingForm.patchValue(_this.realEstate.properties[_this.id]);
                if (_this.realEstate.properties[_this.id].images) {
                    _this.image = _this.realEstate.properties[_this.id].images;
                }
            }
        });
    };
    AddpropertyreComponent.prototype.imgPreviewFeature = function (event) {
        var e_1, _a;
        var _this = this;
            ...
            try {
                for (var files_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](files), files_1_1 = files_1.next(); !files_1_1.done; files_1_1 = files_1.next()) {
                    ...
                    reader.onload = function (e) {
                        _this.imageForm.get('images').push(_this.fb.group({
    ...
    AddpropertyreComponent.prototype.onSubmit = function (clickCheck) {
        if (!this.editMode) {
    ...
    AddpropertyreComponent.prototype.onImageSubmit = function () {
        if (this.image.length) {
            var data_1 = new FormData();
            Array.from(this.image).forEach(function (file) {
                data_1.append('images[]', file);
            });
            data_1.append('_id', this.property._id);
            this.store.dispatch(new _store_realestate_actions__WEBPACK_IMPORTED_MODULE_5__["UploadRealEstatePropertyImages"](data_1));
            if (this.editMode) {
    ...
    AddpropertyreComponent.prototype.pricingSubmit = function () {
        this.dispatch(this.pricingForm.value);
        this.tabSet.select('imagesForm');
    };
    AddpropertyreComponent.prototype.dispatch = function (obj) {
    ...
    AddpropertyreComponent.prototype.ngOnDestroy = function () {
        this.property = null;
    };
    AddpropertyreComponent.ctorParameters = function () { return [
...
var ManagepropertyComponent = /** @class */ (function () {
    function ManagepropertyComponent(store, router, route) {
        this.store = store;
        this.router = router;
        this.route = route;
        this.allProperties = [];
    ...
    ManagepropertyComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('realEstate').subscribe(function (value) {
            ...
            return _this.allProperties = value.realEstate.properties;
        });
    };
    ManagepropertyComponent.prototype.editProperty = function (index) {
        this.router.navigate(['../editProperty', index], { relativeTo: this.route });
    };
    ManagepropertyComponent.prototype.deleteProperty = function (index) {
    ...
    ManagepropertyComponent.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
var PropertyModel = /** @class */ (function () {
    function PropertyModel(_id, listedBy, location, name, starRating, managerName, managerEmail, managerMobile, landmark, address, postalCode, plotSize, contructedArea, contructionYear, lastRenovation, otaChannel, description, facilities, amenities, activities, rent, electricityIncluded, priceNegotiable, securityDeposit, maintenanceCharges, bookingAmount, rentAgreementDuration, noticePeriod, delFlg, images) {
        this._id = _id;
    ...
    PropertyModel.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var RealestateModel = /** @class */ (function () {
    function RealestateModel(profilePercentage, name, registrationType, registrationNo, officeAddress, officePostalCode, registrationAuthority, registrationMsmeNumber, gstNumber, panNumber, tanNumber, unionEnrollmentNumber, mobile, ownerDetails, registrationCinProof, gstNumberProof, registrationMsmeNumberProof, properties) {
    ...
    RealestateModel.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String },
...
var RealestateComponent = /** @class */ (function () {
    function RealestateComponent(store, router, route) {
        this.store = store;
        this.router = router;
        this.route = route;
    }
    RealestateComponent.prototype.ngOnInit = function () {
        ...
        this.store.select('realEstate').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (value) {
...
var RealestateeditComponent = /** @class */ (function () {
    function RealestateeditComponent(fb, store, router, route) {
        this.fb = fb;
        this.store = store;
        this.router = router;
        this.route = route;
    ...
    RealestateeditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.imageForm = this.fb.group({
        ...
        this.store.select('realEstate').subscribe(function (value) {
            console.log(value);
            _this.realEstateStore = value.realEstate;
            _this.previewUrlCinProof = value.realEstate.registrationCinProof !== undefined ? value.realEstate.registrationCinProof : _this.previewUrlCinProof;
            _this.previewUrlgstNumber = value.realEstate.gstNumberProof !== undefined ? value.realEstate.gstNumberProof : _this.previewUrlregistrationMsmeNumber;
            _this.previewUrlregistrationMsmeNumber = value.realEstate.registrationMsmeNumberProof !== undefined ? value.realEstate.registrationMsmeNumberProof : _this.previewUrlgstNumber;
            _this.editForm.patchValue(_this.realEstateStore);
            _this.imageForm.patchValue(_this.realEstateStore);
            if (value.realEstate.ownerDetails !== undefined) {
                _this.ownerForm.patchValue(_this.realEstateStore);
            }
        });
    };
    RealestateeditComponent.prototype.imgPreviewregistrationMsmeNumber = function (fileInput) {
        var _this = this;
    ...
    RealestateeditComponent.prototype.imgPreviewgstNumber = function (fileInput) {
        var _this = this;
    ...
    RealestateeditComponent.prototype.imgPreviewaddress = function (fileInput) {
        var _this = this;
    ...
    RealestateeditComponent.prototype.onImageSubmit = function () {
    ...
    RealestateeditComponent.prototype.onOwnerSubmit = function () {
        this.dispatch(this.ownerForm.value);
        this.tabSet.select('imagesForm');
    };
    RealestateeditComponent.prototype.onSubmit = function () {
        this.dispatch(this.editForm.value);
        this.tabSet.select('ownerDetails');
    };
    RealestateeditComponent.prototype.dispatch = function (obj) {
    ...
    RealestateeditComponent.prototype.navigationTrigger = function () {
        this.navigationCheck = true;
    };
    RealestateeditComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
    ...
    return RealestateeditComponent;
}());
...
var TRY_FETCH_REALESTATE = 'TRY_FETCH_REALESTATE';
var SET_REALESTATE = 'SET_REALESTATE';
var REALESTATE_EDIT = 'REALESTATE_EDIT';
var UPLOAD_REALESTATE_IMAGES = 'UPLOAD_REALESTATE_IMAGES';
var SET_PROPERTY = 'SET_REALESTATE_PROPERTY';
var UPLOAD_PROPERTY_IMAGES = 'UPLOAD_REALESTATE__PROPERTY_IMAGES';
var PROPERTY_EDIT = 'PROPERTY_EDIT';
var PropertyEdit = /** @class */ (function () {
    function PropertyEdit(payload) {
        this.payload = payload;
        this.type = PROPERTY_EDIT;
    }
    PropertyEdit.ctorParameters = function () { return [
        { type: _models_property_model__WEBPACK_IMPORTED_MODULE_1__["PropertyModel"] }
    ]; };
    return PropertyEdit;
}());

var UploadRealEstatePropertyImages = /** @class */ (function () {
    function UploadRealEstatePropertyImages(payload) {
        this.payload = payload;
        this.type = UPLOAD_PROPERTY_IMAGES;
    }
    UploadRealEstatePropertyImages.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UploadRealEstatePropertyImages;
}());

var SetRealEstateProperty = /** @class */ (function () {
    function SetRealEstateProperty(payload) {
        this.payload = payload;
        this.type = SET_PROPERTY;
    }
    SetRealEstateProperty.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return SetRealEstateProperty;
}());

// classes for realestate
var TryFetchRealEstate = /** @class */ (function () {
    function TryFetchRealEstate() {
        this.type = TRY_FETCH_REALESTATE;
    }
    return TryFetchRealEstate;
}());

var SetRealEstate = /** @class */ (function () {
    function SetRealEstate(payload) {
        this.payload = payload;
        this.type = SET_REALESTATE;
    }
    SetRealEstate.ctorParameters = function () { return [
        { type: _models_realestate_model__WEBPACK_IMPORTED_MODULE_0__["RealestateModel"] }
    ]; };
    return SetRealEstate;
}());

var UploadRealEstateImages = /** @class */ (function () {
    function UploadRealEstateImages(payload) {
        this.payload = payload;
        this.type = UPLOAD_REALESTATE_IMAGES;
    }
    UploadRealEstateImages.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UploadRealEstateImages;
}());

var RealEstateEdit = /** @class */ (function () {
    function RealEstateEdit(payload) {
        this.payload = payload;
        this.type = REALESTATE_EDIT;
    }
    RealEstateEdit.ctorParameters = function () { return [
        { type: _models_realestate_model__WEBPACK_IMPORTED_MODULE_0__["RealestateModel"] }
    ]; };
...
var RealestateEffects = /** @class */ (function () {
    function RealestateEffects(action, http, toastService) {
        var _this = this;
        this.action = action;
        this.http = http;
        this.toastService = toastService;
        this.uploadPropertyImage = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_realestate_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_PROPERTY_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadrealestatePropertyImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Voila! Images Uploaded Successfully!');
                return [
                    {
        ...
        this.editProperty = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_realestate_actions__WEBPACK_IMPORTED_MODULE_6__["PROPERTY_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (payload) {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["saverealEstateProperty"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            _this.toastService.showSuccess('Thanks for updating your Property Details!');
            if (response.status === 200) {
                return [
                    {
                        type: _realestate_actions__WEBPACK_IMPORTED_MODULE_6__["SET_PROPERTY"],
        ...
        // effects for realestate
        this.editRealEstate = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_realestate_actions__WEBPACK_IMPORTED_MODULE_6__["REALESTATE_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (payload) {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["editrealestate"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Thanks for updating your Real Estate Company Details!');
                return [
                    {
        ...
        this.uploadRealEstateImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_realestate_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_REALESTATE_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadrealestateImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                _this.toastService.showSuccess('Voila! Images Uploaded Successfully!');
                return [
        ...
        this.fetchRealEstate = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_realestate_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_REALESTATE"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () {
            return _this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchrealestate"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
    ...
    RealestateEffects.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _models_realestate_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/realestate.model */ "./src/app/roles/business/realestate/models/realestate.model.ts");
/* harmony import */ var _models_property_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/property.model */ "./src/app/roles/business/realestate/models/property.model.ts");



var initialState = {
    realEstate: new _models_realestate_model__WEBPACK_IMPORTED_MODULE_1__["RealestateModel"](),
    property: new _models_property_model__WEBPACK_IMPORTED_MODULE_2__["PropertyModel"]()
};
function RealEstateReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case 'SET_REALESTATE': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { realEstate: action.payload });
        }
        case 'SET_REALESTATE_PROPERTY': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { property: action.payload });
        }
        default: {
...
//# sourceMappingURL=realestate-realestate-module-es5.js.map