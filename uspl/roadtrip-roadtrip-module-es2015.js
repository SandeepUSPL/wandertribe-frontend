...
let ManageroadtripComponent = class ManageroadtripComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('RTrips').subscribe(tripState => {
            return this.RTrips = tripState.RTrips;
        });
    }
    editRTrip(index) {
...
ManageroadtripComponent.ctorParameters = () => [
...
let RoadtripRoutingModule = class RoadtripRoutingModule {
};
...
let RoadtripComponent = class RoadtripComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let RoadtripModule = class RoadtripModule {
};
...
class RTripModel {
    constructor(_id, company, location, RTripDates, totalDays, languages, vehicleProvided, vehicleType, vehicleDescription, totalDistance, meetupPoint, about, RTripDayDetails, RTripImage, todoPlan, carry, pricePerPerson, minPeople, maxPeople, RTripTitle, delFlg) {
        this._id = _id;
...
let SaveroadtripComponent = class SaveroadtripComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('RTrips').subscribe(rTrip => {
            if (!this.editMode) {
                if (rTrip.activeRTrip) {
                    this.finalRTrip = rTrip.activeRTrip;
                    if (rTrip.activeRTrip.RTripDayDetails) {
                        this.RTripDaysArray = rTrip.activeRTrip.RTripDayDetails;
                    }
                }
            }
        });
        ...
        this.route.paramMap.subscribe((params) => {
            if (params.get('id')) {
                ...
                this.store.select('RTrips').subscribe(rTrip => {
                    this.finalRTrip = rTrip.RTrips[this.id];
                    if (this.finalRTrip) {
                        this.basicForm.patchValue(this.finalRTrip);
                        this.settingForm.patchValue(this.finalRTrip);
                        this.finalRTrip.RTripDayDetails.forEach((value) => {
                            this.RTripDayDetails.push(this.addRTripDayDetailGroup(value));
                        });
                        this.RTripForm.setValue(this.RTripDayDetails.value[0]);
                    }
                    else {
    ...
    imgPreviewRTripDay(fileInput) {
        this.RTripDayImg = fileInput.target.files[0];
        const mimeType = this.RTripDayImg.type;
        ...
        reader.onload = () => {
            this.imgPreviewUrlRTripDay = reader.result;
        };
    }
    imgPreviewRTrip(fileInput) {
        ...
        if (files.length >= 5) {
            for (const image of files) {
                ...
                const reader = new FileReader();
                reader.onload = (e) => {
                    this.settingForm.get('RTripImage').push(this.fb.group({
                        url: e.target.result
                    }));
                };
    ...
    settingFormSubmit() {
        ...
        if (this.RTripImgArray.length) {
            const data = new FormData();
            data.append('_id', this.finalRTrip._id);
            Array.from(this.RTripImgArray).forEach(image => {
                data.append('RTripImage[]', image);
            });
            this.store.dispatch(new _store_rtrips_actions__WEBPACK_IMPORTED_MODULE_8__["TryUploadRoadTripImage"](data));
        }
        this.router.navigate(['../manageRTrip'], { relativeTo: this.route });
...
SaveroadtripComponent.ctorParameters = () => [
...
const TRY_SAVE_RTRIP = 'TRY_SAVE_RTRIP';
const TRY_FETCH_RTRIPS = 'TRY_FETCH_RTRIPS';
const TRY_UPLOAD_RTRIP_IMAGE = 'TRY_UPLOAD_RTRIP_IMAGE';
const SET_RTRIPS = 'SET_RTRIPS';
const SET_ACTIVE_RTRIP = 'SET_ACTIVE_RTRIP';
class TryUploadRoadTripImage {
    constructor(payload) {
        this.payload = payload;
        this.type = TRY_UPLOAD_RTRIP_IMAGE;
    }
}
TryUploadRoadTripImage.ctorParameters = () => [
    { type: undefined }
];
class TryFetchRTrips {
    constructor() {
...
SetRTrips.ctorParameters = () => [
    { type: Array }
];
class SetActiveRTrip {
    constructor(payload) {
        this.payload = payload;
        this.type = SET_ACTIVE_RTRIP;
    }
}
SetActiveRTrip.ctorParameters = () => [
    { type: _rtrip_model__WEBPACK_IMPORTED_MODULE_0__["RTripModel"] }
];
...
let RTripsEffects = class RTripsEffects {
    constructor(action, http) {
        this.action = action;
        this.http = http;
        this.uploadImage = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_rtrips_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_UPLOAD_RTRIP_IMAGE"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["uploadRTripImage"], data, { observe: 'response' });
        ...
        this.editRTrip = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_rtrips_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_SAVE_RTRIP"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["saveRTrip"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchRTrips = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_rtrips_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_FETCH_RTRIPS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_1__["fetchRTrips"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((response) => {
            if (response.status === 200) {
...
function RTripsReducer(state = initialState, action) {
    switch (action.type) {
        case 'SET_ACTIVE_RTRIP': {
            return Object.assign({}, state, { activeRTrip: action.payload });
        }
        case 'SET_RTRIPS': {
            return Object.assign({}, state, { RTrips: action.payload });
        }
        default: {
...
//# sourceMappingURL=roadtrip-roadtrip-module-es2015.js.map