 ...
 *   formats to: 1024
*/
let RoleCasePipe = class RoleCasePipe {
    constructor() {
        this.val = '';
    }
    transform(value) {
...
let AddrolesComponent = class AddrolesComponent {
    ...
    onAddSelectOption() {
        const obj = new _models_SubmitOption_model__WEBPACK_IMPORTED_MODULE_4__["SubmitOptionModel"](this.dynamicForm.get('optionLabel').value, this.dynamicForm.get('optionValue').value);
        this.selectOptions.push(obj);
        this.dynamicForm.get('optionLabel').patchValue('');
        this.dynamicForm.get('optionValue').patchValue('');
    }
    onChangeSelectOption(i) {
        const obj = new _models_SubmitOption_model__WEBPACK_IMPORTED_MODULE_4__["SubmitOptionModel"](this.dynamicForm.get('oldOptionLabel').value, this.dynamicForm.get('oldOptionValue').value);
        this.selectOptions[i] = obj;
        console.log(this.selectOptions);
    }
    onDeleteSelectOption(i) {
    ...
    onAddNewFormOption() {
        ...
        const obj = new _models_fields_model__WEBPACK_IMPORTED_MODULE_3__["FieldsModel"](this.dynamicForm.get('name').value, this.dynamicForm.get('type').value, this.dynamicForm.get('placeholder').value, this.dynamicForm.get('label').value, this.dynamicForm.get('value').value);
...
const businessRoutes = [
    {
        path: '', component: _business_component__WEBPACK_IMPORTED_MODULE_3__["BusinessComponent"], children: [
            { path: 'list', component: _businesslist_businesslist_component__WEBPACK_IMPORTED_MODULE_4__["BusinesslistComponent"] },
            {
                ...
                loadChildren: () => __webpack_require__.e(/*! import() | transportation-transportation-module */ "transportation-transportation-module").then(__webpack_require__.bind(null, /*! ./transportation/transportation.module */ "./src/app/roles/business/transportation/transportation.module.ts")).then(module => module.TransportationModule)
            },
            {
                path: 'propertiesBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | properties-properties-module */ "properties-properties-module").then(__webpack_require__.bind(null, /*! ./properties/properties.module */ "./src/app/roles/business/properties/properties.module.ts")).then(module => module.PropertiesModule)
            },
            {
                path: 'serviceSupplierBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | servicesupplier-servicesupplier-module */ "servicesupplier-servicesupplier-module").then(__webpack_require__.bind(null, /*! ./servicesupplier/servicesupplier.module */ "./src/app/roles/business/servicesupplier/servicesupplier.module.ts")).then(module => module.ServicesupplierModule)
            },
            {
                path: 'realEstateBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | realestate-realestate-module */ "realestate-realestate-module").then(__webpack_require__.bind(null, /*! ./realestate/realestate.module */ "./src/app/roles/business/realestate/realestate.module.ts")).then(module => module.RealestateModule)
            },
            {
                path: 'financeBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | finance-finance-module */ "finance-finance-module").then(__webpack_require__.bind(null, /*! ./finance/finance.module */ "./src/app/roles/business/finance/finance.module.ts")).then(module => module.FinanceModule)
            },
            {
                path: 'travelAgentBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | travelagent-travelagent-module */ "travelagent-travelagent-module").then(__webpack_require__.bind(null, /*! ./travelagent/travelagent.module */ "./src/app/roles/business/travelagent/travelagent.module.ts")).then(module => module.TravelagentModule)
            },
            {
                path: 'travelCuratorBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | travelcurator-travelcurator-module */ "travelcurator-travelcurator-module").then(__webpack_require__.bind(null, /*! ./travelcurator/travelcurator.module */ "./src/app/roles/business/travelcurator/travelcurator.module.ts")).then(module => module.TravelcuratorModule)
            },
            {
                path: 'jobsBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | jobs-jobs-module */ "jobs-jobs-module").then(__webpack_require__.bind(null, /*! ./jobs/jobs.module */ "./src/app/roles/business/jobs/jobs.module.ts")).then(module => module.JobsModule)
            },
            {
                path: 'treksBusiness',
                loadChildren: () => Promise.all(/*! import() | treks-treks-module */[__webpack_require__.e("default~events-events-module~treks-treks-module"), __webpack_require__.e("treks-treks-module")]).then(__webpack_require__.bind(null, /*! ./treks/treks.module */ "./src/app/roles/business/treks/treks.module.ts")).then(module => module.TreksBusinessModule)
            },
            {
                path: 'eventsBusiness',
                loadChildren: () => Promise.all(/*! import() | events-events-module */[__webpack_require__.e("default~events-events-module~treks-treks-module"), __webpack_require__.e("events-events-module")]).then(__webpack_require__.bind(null, /*! ./events/events.module */ "./src/app/roles/business/events/events.module.ts")).then(module => module.EventsModule)
            },
            {
                path: 'roadTripBusiness',
                loadChildren: () => __webpack_require__.e(/*! import() | roadtrip-roadtrip-module */ "roadtrip-roadtrip-module").then(__webpack_require__.bind(null, /*! ./roadtrip/roadtrip.module */ "./src/app/roles/business/roadtrip/roadtrip.module.ts")).then(module => module.RoadtripModule)
            },
            {
                path: 'myProfile',
                loadChildren: () => __webpack_require__.e(/*! import() | myprofile-myprofile-module */ "myprofile-myprofile-module").then(__webpack_require__.bind(null, /*! ./myprofile/myprofile.module */ "./src/app/roles/business/myprofile/myprofile.module.ts")).then(module => module.MyprofileModule)
            }
        ]
    }
];
...
let BusinesslistComponent = class BusinesslistComponent {
    constructor(sidebarService, store, route, http, router, toastService) {
        this.sidebarService = sidebarService;
        this.store = store;
        this.route = route;
        this.http = http;
    ...
    ngOnInit() {
        ...
        this.store.select('authState').subscribe((value) => {
            ...
            if (value.profile.profileImage) {
                this.profilePic = value.profile.profileImage;
            }
            this.roles = ['jobsBusiness'];
            for (const x in value.profile.roles.business) {
...
class SubmitOptionModel {
    constructor(name, value) {
        this.name = name;
        this.value = value;
    }
}
SubmitOptionModel.ctorParameters = () => [
    { type: String },
    { type: String }
];
...
class FieldsModel {
    constructor(name, type, placeholder, label, value) {
        this.name = name;
        this.type = type;
...
class RoleGuardService {
    ...
    canActivate(route, state) {
        this.store.select('authState').subscribe(value => {
            this.roleCheck = false;
            this.profile = value.profile.roles;
            if (Object.keys(this.profile).indexOf(route.url[0].path) !== (-1)) {
                this.roleCheck = true;
            }
        });
...
const roleRoutes = [
    {
        path: '', component: _roleslist_roleslist_component__WEBPACK_IMPORTED_MODULE_3__["RoleslistComponent"], children: [
            // roles for business
            {
                path: 'b', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./business/business.module */ "./src/app/roles/business/business.module.ts")).then(module => module.BusinessModule)
            },
        ]
    },
];
...
let RoleshomeComponent = class RoleshomeComponent {
    constructor(router, route) {
        this.router = router;
        this.route = route;
    }
...
RoleshomeComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
//# sourceMappingURL=roles-role-module-es2015.js.map