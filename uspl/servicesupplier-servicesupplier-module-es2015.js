...
let ServicesupplierRoutingModule = class ServicesupplierRoutingModule {
};
...
let ServicesupplierComponent = class ServicesupplierComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
ServicesupplierModel.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
let ServicesupplierModule = class ServicesupplierModule {
};
...
let ServicesuppliereditComponent = class ServicesuppliereditComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('serviceSupplier').subscribe(value => {
            console.log(value);
            this.serviceSupplierStore = value.serviceSupplier;
            this.previewUrlCinProof = value.serviceSupplier.registrationCinProof;
            this.previewUrlgstNumber = value.serviceSupplier.gstNumberProof;
            this.previewUrlregistrationMsmeNumber = value.serviceSupplier.registrationMsmeNumberProof;
            // this.previewUrlregistrationNo = value.serviceSupplier.registrationNoProof;
            this.editForm.patchValue(this.serviceSupplierStore);
            this.imageForm.patchValue(this.serviceSupplierStore);
            this.ownerForm.patchValue(this.serviceSupplierStore);
        });
    }
...
ServicesuppliereditComponent.ctorParameters = () => [
...
const TRY_FETCH_SERVICESUPPLIER = 'TRY_FETCH_SERVICESUPPLIER';
const SET_SERVICESUPPLIER = 'SET_SERVICESUPPLIER';
const SERVICESUPPLIER_EDIT = 'SERVICESUPPLIER_EDIT';
const UPLOAD_SERVICESUPPLIER_IMAGES = 'UPLOAD_SERVICESUPPLIER_IMAGES';
// classes for service supplier
class TryFetchServiceSupplier {
    constructor() {
        this.type = TRY_FETCH_SERVICESUPPLIER;
    }
}
class SetServiceSupplier {
    constructor(payload) {
        this.payload = payload;
        this.type = SET_SERVICESUPPLIER;
    }
}
SetServiceSupplier.ctorParameters = () => [
    { type: undefined }
];
class UploadServiceSupplierImages {
    constructor(payload) {
        this.payload = payload;
        this.type = UPLOAD_SERVICESUPPLIER_IMAGES;
    }
}
UploadServiceSupplierImages.ctorParameters = () => [
    { type: undefined }
];
class ServiceSupplierEdit {
    constructor(payload) {
        this.payload = payload;
        this.type = SERVICESUPPLIER_EDIT;
    }
}
ServiceSupplierEdit.ctorParameters = () => [
    { type: undefined }
];
...
let ServicesupplierEffects = class ServicesupplierEffects {
    constructor(action, http) {
        this.action = action;
        this.http = http;
        // effects for service supplier
        this.editServiceSupplier = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_servicesupplier_actions__WEBPACK_IMPORTED_MODULE_5__["SERVICESUPPLIER_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((payload) => {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["editservicesuppliers"], data, { observe: 'response' });
        ...
        this.uploadServiceSupplierImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_servicesupplier_actions__WEBPACK_IMPORTED_MODULE_5__["UPLOAD_SERVICESUPPLIER_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["uploadservicesuppliersImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchServiceSupplier = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_servicesupplier_actions__WEBPACK_IMPORTED_MODULE_5__["TRY_FETCH_SERVICESUPPLIER"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_6__["fetchservicesuppliers"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
...
ServicesupplierEffects.ctorParameters = () => [
...
/* harmony import */ var _servicesupplier_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../servicesupplier.model */ "./src/app/roles/business/servicesupplier/servicesupplier.model.ts");

const initialState = {
    serviceSupplier: new _servicesupplier_model__WEBPACK_IMPORTED_MODULE_0__["ServicesupplierModel"]('', '', '', '', '', '', '', '', '', '', {
        permanentAddress: {
            address: '',
            pincode: '',
            phoneNo: ''
...
function ServiceSupplierReducer(state = initialState, action) {
    switch (action.type) {
        case 'SET_SERVICESUPPLIER':
            return Object.assign({}, state, { serviceSupplier: action.payload });
        default: {
...
//# sourceMappingURL=servicesupplier-servicesupplier-module-es2015.js.map