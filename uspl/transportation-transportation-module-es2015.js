...
let ActiveRouteDirective = class ActiveRouteDirective {
...
ActiveRouteDirective.ctorParameters = () => [
...
let ListvehicleComponent = class ListvehicleComponent {
    constructor(store, fb, authStore, route, router) {
        this.store = store;
        this.fb = fb;
    ...
    ngOnInit() {
        ...
        this.store.select('transportation').subscribe((vehicleState) => {
...
ListvehicleComponent.ctorParameters = () => [
...
class TransportationModel {
    constructor(profilePercentage, name, registrationType, registrationNo, officeAddress, officePostalCode, registrationAuthority, registrationMsmeNumber, gstNumber, panNumber, tanNumber, unionEnrollmentNumber, mobile, ownerDetails, registrationCinProof, gstNumberProof, registrationMsmeNumberProof) {
...
TransportationModel.ctorParameters = () => [
    { type: Number },
    { type: String },
    { type: String },
    { type: String },
...
class VehicleModel {
    constructor(_id, ownerId, registrationNo, registrationYear, registrationState, vehicleBrand, insurancePolicyNo, kmsCovered, vehicleColour, noOfSeats, vehicleType, vehicleRcImage, vehicleInsuranceImage, vehiclePucImage, vehicleFitnessImage) {
        this._id = _id;
...
let SavevehicleComponent = class SavevehicleComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('transportation').subscribe((vehicleState) => {
            this.vehicle = vehicleState.currentVehicle;
            this.editVehicleForm.patchValue(vehicleState.currentVehicle);
            this.imageForm.patchValue(vehicleState.currentVehicle);
        });
    }
    imgPreviewVehicleRc(fileInput) {
        this.vehicleRcImage = fileInput.target.files[0];
        const mimeType = this.vehicleRcImage.type;
        ...
        reader.onload = () => {
            this.previewUrlRc = reader.result;
        };
    }
    imgPreviewInsurance(fileInput) {
        this.vehicleInsuranceImage = fileInput.target.files[0];
        const mimeType = this.vehicleInsuranceImage.type;
        if (mimeType.match(/image\/*/) == null) {
            return;
        }
        const reader = new FileReader();
        ...
        reader.onload = () => {
            this.previewUrlInsurance = reader.result;
        };
    }
    imgPreviewPuc(fileInput) {
        this.vehiclePucImage = fileInput.target.files[0];
        const mimeType = this.vehiclePucImage.type;
        if (mimeType.match(/image\/*/) == null) {
            return;
        }
        const reader = new FileReader();
        ...
        reader.onload = () => {
            this.previewUrlPuc = reader.result;
        };
    }
    imgPreviewFitness(fileInput) {
        this.vehicleFitnessImage = fileInput.target.files[0];
        const mimeType = this.vehicleFitnessImage.type;
        if (mimeType.match(/image\/*/) == null) {
            return;
        }
        const reader = new FileReader();
        ...
        reader.onload = () => {
            this.previewUrlFitness = reader.result;
        };
    }
    onSubmitImages() {
...
SavevehicleComponent.ctorParameters = () => [
...
const TRANSPORTATION_EDIT = 'TRANSPORTATION_EDIT';
const SAVE_VEHICLES = 'SAVE_VEHICLES';
const SET_VEHICLES = 'SET_VEHICLES';
const SET_TRANSPORTATION = 'SET_TRANSPORTATION';
const TRY_FETCH_VEHICLES = 'TRY_FETCH_VEHICLES';
const TRY_FETCH_TRANSPORTATION = 'TRY_FETCH_TRANSPORTATION';
const UPLOAD_TRANSPORTATION_IMAGES = 'UPLOAD_TRANSPORTATION_IMAGES';
const UPLOAD_VEHICLE_IMAGES = 'UPLOAD_VEHICLE_IMAGES';
const SET_CURRENT_VEHICLE = 'SET_CURRENT_VEHICLE';
...
UploadVehicleImages.ctorParameters = () => [
    { type: undefined }
];
class UploadTransportationImages {
    constructor(payload) {
        this.payload = payload;
        this.type = UPLOAD_TRANSPORTATION_IMAGES;
    }
}
UploadTransportationImages.ctorParameters = () => [
    { type: undefined }
];
class TryFetchTransportation {
    constructor() {
        this.type = TRY_FETCH_TRANSPORTATION;
    }
}
class SetTransportation {
    constructor(payload) {
        this.payload = payload;
        this.type = SET_TRANSPORTATION;
    }
}
SetTransportation.ctorParameters = () => [
...
TransportationEdit.ctorParameters = () => [
    { type: _models_transportation_model__WEBPACK_IMPORTED_MODULE_1__["TransportationModel"] }
];
class SaveVehicles {
    constructor(payload) {
...
SetVehicles.ctorParameters = () => [
    { type: Array }
];
class TryFetchVehicles {
    constructor() {
        this.type = TRY_FETCH_VEHICLES;
    }
}
class SetCurrentVehicle {
    constructor(payload) {
        this.payload = payload;
        this.type = SET_CURRENT_VEHICLE;
    }
}
SetCurrentVehicle.ctorParameters = () => [
...
let TransportationEffects = class TransportationEffects {
    constructor(action, http, router, route) {
        this.action = action;
        this.http = http;
        this.router = router;
        this.route = route;
        this.uploadVehicleImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_VEHICLE_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadVehicleImages"], data, { observe: 'response' });
        ...
        this.uploadTransportationImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_TRANSPORTATION_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadTransportationImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchTransportation = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_TRANSPORTATION"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchTransportation"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
        ...
        this.fetchVehicles = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_VEHICLES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchVehicles"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
        ...
        this.SaveVehicles = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["SAVE_VEHICLES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((payload) => {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["saveVehicles"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                this.router.navigate(['/roles/b/transportationBusiness/saveVehicle']);
                return [
        ...
        this.editTransportation = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_transportation_actions__WEBPACK_IMPORTED_MODULE_6__["TRANSPORTATION_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((payload) => {
            console.log(1);
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
            console.log(2);
            return this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["editTransportation"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status === 200) {
                return [
                    {
...
TransportationEffects.ctorParameters = () => [
...
/* harmony import */ var _models_transportation_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/transportation.model */ "./src/app/roles/business/transportation/models/transportation.model.ts");
/* harmony import */ var _models_vehicle_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/vehicle.model */ "./src/app/roles/business/transportation/models/vehicle.model.ts");


const initialState = {
    transportation: new _models_transportation_model__WEBPACK_IMPORTED_MODULE_0__["TransportationModel"](),
    vehicles: [],
    currentVehicle: new _models_vehicle_model__WEBPACK_IMPORTED_MODULE_1__["VehicleModel"]()
};
function TransportationReducer(state = initialState, action) {
    switch (action.type) {
        case 'SET_VEHICLES': {
        ...
        case 'SET_TRANSPORTATION': {
            ...
            return Object.assign({}, state, { transportation: action.payload });
        }
...
let TransportationRoutingModule = class TransportationRoutingModule {
};
...
let TransportationComponent = class TransportationComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('transportation').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(value => {
            // console.log(value);
...
TransportationComponent.ctorParameters = () => [
...
let TransportationModule = class TransportationModule {
};
...
let TransportationeditComponent = class TransportationeditComponent {
    ...
    ngOnInit() {
        ...
        this.store.select('transportation').subscribe(value => {
            console.log(value);
            this.transportationStore = value.transportation;
            this.previewUrlCinProof = value.transportation.registrationCinProof ? value.transportation.registrationCinProof : this.previewImage;
            this.previewUrlgstNumber = value.transportation.gstNumberProof ? value.transportation.gstNumberProof : this.previewImage;
            this.previewUrlregistrationMsmeNumber = value.transportation.registrationMsmeNumberProof ? value.transportation.registrationMsmeNumberProof : this.previewImage;
            this.editForm.patchValue(value.transportation);
            this.imageForm.patchValue(value.transportation);
            if (value.transportation.ownerDetails !== undefined) {
                this.ownerForm.patchValue(value.transportation);
            }
        });
    }
...
TransportationeditComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
//# sourceMappingURL=transportation-transportation-module-es2015.js.map