...
// travel curator
var TRY_FETCH_TRAVELCURATOR = 'TRY_FETCH_TRAVELCURATOR';
var SET_TRAVELCURATOR = 'SET_TRAVELCURATOR';
var TRAVELCURATOR_EDIT = 'TRAVELCURATOR_EDIT';
var UPLOAD_TRAVELCURATOR_IMAGES = 'UPLOAD_TRAVELCURATOR_IMAGES';
// classes for travel curator
var TryFetchTravelCurator = /** @class */ (function () {
    function TryFetchTravelCurator() {
        this.type = TRY_FETCH_TRAVELCURATOR;
    }
    return TryFetchTravelCurator;
}());

var SetTravelCurator = /** @class */ (function () {
    function SetTravelCurator(payload) {
        this.payload = payload;
        this.type = SET_TRAVELCURATOR;
    }
    SetTravelCurator.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SetTravelCurator;
}());

var UploadTravelCuratorImages = /** @class */ (function () {
    function UploadTravelCuratorImages(payload) {
        this.payload = payload;
        this.type = UPLOAD_TRAVELCURATOR_IMAGES;
    }
    UploadTravelCuratorImages.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UploadTravelCuratorImages;
}());

var TravelCuratorEdit = /** @class */ (function () {
    function TravelCuratorEdit(payload) {
        this.payload = payload;
        this.type = TRAVELCURATOR_EDIT;
    }
    TravelCuratorEdit.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return TravelCuratorEdit;
}());
...
var TravelcuratorEffects = /** @class */ (function () {
    function TravelcuratorEffects(action, http) {
        var _this = this;
        this.action = action;
        this.http = http;
        // effects for travel curator
        this.editTravelCurator = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_travelcurator_actions__WEBPACK_IMPORTED_MODULE_6__["TRAVELCURATOR_EDIT"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (payload) {
            return payload.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["edittravelcurator"], data, { observe: 'response' });
        ...
        this.uploadTravelCuratorImages = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_travelcurator_actions__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_TRAVELCURATOR_IMAGES"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.payload;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (data) {
            return _this.http.post(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["uploadtravelcuratorImages"], data, { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
        ...
        this.fetchTravelCurator = this.action.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_travelcurator_actions__WEBPACK_IMPORTED_MODULE_6__["TRY_FETCH_TRAVELCURATOR"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () {
            return _this.http.get(_shared_serverEndpoints__WEBPACK_IMPORTED_MODULE_5__["fetchtravelcurator"], { observe: 'response' });
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (response) {
            if (response.status === 200) {
                return [
                    {
    ...
    TravelcuratorEffects.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _travelcurator_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../travelcurator.model */ "./src/app/roles/business/travelcurator/travelcurator.model.ts");


var initialState = {
    travelCurator: new _travelcurator_model__WEBPACK_IMPORTED_MODULE_1__["TravelcuratorModel"]('', '', '', '', '', '', '', '', '', '', {
        permanentAddress: {
            address: '',
            pincode: '',
            phoneNo: ''
...
function TravelcuratorReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case 'SET_TRAVELCURATOR': {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { travelCurator: action.payload });
        }
        default: {
...
var TravelcuratorRoutingModule = /** @class */ (function () {
    function TravelcuratorRoutingModule() {
    }
    ...
    return TravelcuratorRoutingModule;
}());
...
var TravelcuratorComponent = /** @class */ (function () {
    function TravelcuratorComponent() {
    }
    TravelcuratorComponent.prototype.ngOnInit = function () {
    };
...
var TravelcuratorModel = /** @class */ (function () {
    function TravelcuratorModel(name, registrationType, registrationNo, registrationNoProof, officeAddress, registrationAuthority, registrationMsmeNumber, gstNumber, panNumber, unionEnrollmentNumber, firmAddress, ownerDetails, registrationCinProof, gstNumberProof, registrationMsmeNumberProof) {
        this.name = name;
    ...
    TravelcuratorModel.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var TravelcuratorModule = /** @class */ (function () {
    function TravelcuratorModule() {
    }
...
var TravelcuratoreditComponent = /** @class */ (function () {
    function TravelcuratoreditComponent(fb, store) {
        this.fb = fb;
        this.store = store;
    ...
    TravelcuratoreditComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.store.select('travelCurator').subscribe(function (value) {
            console.log(value);
            _this.travelCuratorStore = value.travelCurator;
            _this.previewUrlCinProof = value.travelCurator.registrationCinProof;
            _this.previewUrlgstNumber = value.travelCurator.gstNumberProof;
            _this.previewUrlregistrationMsmeNumber = value.travelCurator.registrationMsmeNumberProof;
            _this.editForm.patchValue(_this.travelCuratorStore);
            _this.imageForm.patchValue(_this.travelCuratorStore);
            _this.ownerForm.patchValue(_this.travelCuratorStore);
        });
    };
    TravelcuratoreditComponent.prototype.imgPreviewregistrationMsmeNumber = function (fileInput) {
        var _this = this;
    ...
    TravelcuratoreditComponent.prototype.imgPreviewgstNumber = function (fileInput) {
        var _this = this;
    ...
    TravelcuratoreditComponent.prototype.imgPreviewaddress = function (fileInput) {
        var _this = this;
    ...
    TravelcuratoreditComponent.prototype.onSubmit = function (type) {
        if (type === 'imageForm') {
    ...
    TravelcuratoreditComponent.ctorParameters = function () { return [
    ...
    return TravelcuratoreditComponent;
}());
...
//# sourceMappingURL=travelcurator-travelcurator-module-es5.js.map