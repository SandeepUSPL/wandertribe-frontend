...
<head>
    ...
    <title>Why WanderTribe ? | Why should Property Owners on-board wandertribe ?</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact-item">
                    <h4 class="title-section mt-30"><span class="font-bold">Why WanderTribe ?</span></h4>
                    <div class="cws_divider mb-25 mt-5"></div>

                    <!--                <h5 class="pb-20 pt-20">Why should Property Owners on-board wandertribe ?</h5>-->
                    <div class="col-md-8">
                        <ul style="list-style-type: disc; padding-left: 50px; width: 90%">

                            <li><h6><span style="font-size: larger">Digital Marketing:</span> Active Digital Marketing &
                                    Promotion of properties.</h6></li>
                            <li><h6><span style="font-size: larger">Online Sales Platform:</span> Integrated software
                                    for bookings, inventory, channel management etc.</h6></li>
                            <li><h6><span style="font-size: larger">Offline Sales Support:</span> Provide sales support
                                    for offline sales to corporate and travel agencies.</h6></li>
                            <li><h6><span style="font-size: larger">Marketing & Sales Offices:</span> Access to
                                    marketing & sales offices across cities.</h6></li>
                            <li><h6><span style="font-size: larger">Property Branding:</span> Website & Logo design of
                                    properties for better branding.</h6></li>
                            <li><h6><span style="font-size: larger">Staff Training:</span> For upgrading their
                                    hospitality sector skills.</h6></li>
                            <li><h6><span style="font-size: larger">Travel Exhibitions:</span> Travel & Tourism
                                    Exhibition Representation (like SATTE, Travel Mart, Travel Road shows etc.)</h6>
                            </li>
                            <li><h6><span style="font-size: larger">Standardized Supplies:</span> To improve the service
                                    quality of travel service providers.</h6></li>
                            <li><h6><span style="font-size: larger">Call-Center:</span> A dedicated call-center for
                                    reservations and information.</h6></li>
                            <li><h6><span style="font-size: larger"> Real-Estate Services:</span> Property Leasing &
                                    Insurance Assistance.</h6></li>

                        </ul>
                    </div>
                    <div class="col-md-4">
                        <img src="img/vendorbenifits.png" alt=""
                             style="width: 100%; padding-top: 100px; filter: invert(4%) sepia(72%) saturate(3747%) hue-rotate(293deg) brightness(97%) contrast(98%);">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container pt-50">
        <div class="row">
            ...
            <div class="col-lg-12 text-center">
                ...
                <a href="https://www.linkedin.com/company/wandertribe"><img class="social-icons"
                                                                            src="img/Linkedin_icon.png"></a>
